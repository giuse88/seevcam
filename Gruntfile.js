...
//	Task registration
	grunt.shipit.on('published', function () {
		grunt.task.run(['npm_install','bower_install', 'minify','env_update','django_log_link']);
//		grunt.task.run(['npm_install','bower_install', 'minify','env_update','django_log_link','django_migrate','django_runserver']);
	});
};