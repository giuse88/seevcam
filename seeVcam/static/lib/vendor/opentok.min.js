define(function (require) {
  ...
  /*
   OpenTok JavaScript Library v2.2.9.6
   http://www.tokbox.com/
   ...
   TB Plugin 0.4.0.8 dc876b4 HEAD
   http://www.tokbox.com/
  ...
  !function (b, a) {
    ...
    d.keys = Object.keys || function (a) {
      var c = [], e = Object.prototype.hasOwnProperty, b;
    ...
    var k = Array.prototype.map || function (a, e) {
      var b = [];
    ...
    var f = Array.prototype.filter || function (a, e) {
      var b = [];
      c.call(this, function (c, f) {
    ...
    var g = Array.prototype.some || function (a, c) {
    ...
    var h = Array.prototype.indexOf || function (a, c) {
      var e;
      e = c ? c : 0;
      var b;
    ...
    var m = Function.prototype.bind || function () {
      var a = Array.prototype.slice.call(arguments), c = a.shift(), e = this;
      return function () {
        return e.apply(c, a.concat(Array.prototype.slice.call(arguments)))
      }
    };
    d.bind = function () {
      var a = Array.prototype.slice.call(arguments), c = a.shift();
      return m.apply(c, a)
    };
    ...
    d.isArray = d.isFunction(Array.isArray) && Array.isArray || function (a) {
    ...
    d.now = function () {
      var a = b.performance || {}, c, e = a.now || a.mozNow || a.msNow || a.oNow || a.webkitNow;
    ...
    var n = function () {
      var a = b.navigator.userAgent.toLowerCase(), c = b.navigator.appName, e, f = "unknown", k = -1;
      if (-1 < a.indexOf("opera") || -1 < a.indexOf("opr"))f = "Opera", null !== /opr\/([0-9]{1,}[\.0-9]{0,})/.exec(a) && (k = parseFloat(RegExp.$1)); else if (-1 < a.indexOf("firefox"))f = "Firefox", null !==
        /firefox\/([0-9]{1,}[\.0-9]{0,})/.exec(a) && (k = parseFloat(RegExp.$1)); else if ("Microsoft Internet Explorer" === c)f = "IE", null !== /msie ([0-9]{1,}[\.0-9]{0,})/.exec(a) && (k = parseFloat(RegExp.$1)); else if ("Netscape" === c && -1 < a.indexOf("trident"))f = "IE", null !== /trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(a) && (k = parseFloat(RegExp.$1)); else if (-1 < a.indexOf("chrome"))f = "Chrome", null !== /chrome\/([0-9]{1,}[\.0-9]{0,})/.exec(a) && (k = parseFloat(RegExp.$1)); else if ((e = b.navigator.vendor) && -1 < e.toLowerCase().indexOf("apple"))f =
        "Safari", null !== /version\/([0-9]{1,}[\.0-9]{0,})/.exec(a) && (k = parseFloat(RegExp.$1));
      return{browser: f, version: k, iframeNeedsLoad: 0 > a.indexOf("webkit")}
    }();
    d.browser = function () {
      return n.browser
    };
    ...
    d.defineGetters = function (a, c, e) {
      var b = {};
      void 0 === e && (e = !1);
      for (var f in c)b[f] = {get: c[f], enumerable: e};
    ...
    d.getCookie = function (a) {
      ...
      try {
        ...
        for (var b = document.cookie.split(";"), f = 0; f < b.length; f++) {
          for (var k = b[f]; " " === k.charAt(0);)k = k.substring(1, k.length);
    ...
    var p = {escape: {"\x26": "\x26amp;", "\x3c": "\x26lt;", "\x3e": "\x26gt;", '"': "\x26quot;",
      "'": "\x26#x27;", "/": "\x26#x2F;"}};
    p.unescape = d.invert(p.escape);
    var t = {escape: RegExp("[" + d.keys(p.escape).join("") + "]", "g"), unescape: RegExp("(" + d.keys(p.unescape).join("|") + ")", "g")};
    ...
    d.template = function (a, c, e) {
      ...
      var f = RegExp([(e.escape || v).source, (e.interpolate || v).source, (e.evaluate || v).source].join("|") + "|$", "g"), k = 0, g = "__p+\x3d'";
  ...
  (function (b, a, d) {
    ...
    var k, f = Array(16);
    d = function () {
      for (var a, c = 0, c = 0; 16 > c; c++)0 === (c &
        3) && (a = 4294967296 * Math.random()), f[c] = a >>> ((c & 3) << 3) & 255;
      return f
    };
    ...
    var h = k || d, m = "function" === typeof Buffer ? Buffer : Array, e = [], n = {};
  ...
  (function (b, a, d) {
    a.useLogHelpers = function (d) {
      function c(a, c, f) {
        return function () {
          if (d.shouldLog(c)) {
            var h = b.console, n = q(arguments);
            if (h && h[a])if (h[a].apply || e)h[a].apply || (h[a] = Function.prototype.bind.call(h[a], h)), h[a].apply(h, n); else h[a](n); else if (f) {
              f.apply(d, n);
              return
            }
      ...
      function g(c) {
        var e =
          [];
        if ("undefined" !== typeof c)if (null === c)e.push("NULL"); else if (a.isArray(c))for (var b = 0; b < c.length; ++b)e.push(f(c[b])); else if (a.isObject(c))for (b in c) {
          var k;
  ...
  (function (b, a, d) {
    a.on = function (a, c, b) {
      if (a.addEventListener)a.addEventListener(c, b, !1); else if (a.attachEvent)a.attachEvent("on" + c, b); else {
        var f = a["on" + c];
        a["on" + c] = function () {
  ...
  (function (b, a, d) {
    var l = "undefined" === typeof document || "complete" === document.readyState || "interactive" === document.readyState && document.body, c = [], k = [], f = !1, g = function () {
      l = !0;
      a.on(b, "unload", h);
  ...
  (function (b, a, d) {
    if (function () {
      ...
      var l = [], c = "OTHelpers." + a.uuid.v4() + ".zero-timeout", k = function () {
        l = [];
  ...
  (function (b, a, d) {
    a.eventing = function (b, c) {
      ...
      var g = {}, h = !0 === c ? f : d, m = function (c, b) {
        g[c] &&
        (b ? g[c] = a.filter(g[c], function (a) {
          return a.context !== b
        }) : delete g[c])
      ...
      b.dispatchEvent = function (c, b) {
        if (!c.type)throw a.error("OTHelpers.Eventing.dispatchEvent: Event has no type"),
          a.error(c), Error("OTHelpers.Eventing.dispatchEvent: Event has no type");
      ...
      b.on = function (a, c, b) {
        if ("string" === typeof a && c)e(a.split(" "), c, b); else for (var f in a)a.hasOwnProperty(f) && e([f], a[f], c);
        return this
      };
      b.off = function (c, b, e) {
        if ("string" === typeof c)b &&
        a.isFunction(b) ? n(c.split(" "), b, e) : a.forEach(c.split(" "), function (a) {
          m(a, b)
        }, this); else if (c)for (var f in c)c.hasOwnProperty(f) && n([f], c[f], b); else g = {};
        return this
      };
  ...
  (function (b, a, d) {
    ...
    a.observeStyleChanges =
      function (c, b, f) {
        ...
        m.observe(c, {attributes: !0, attributeFilter: ["style"],
          childList: !1, characterData: !1, subtree: !1});
        return m
      };
    a.observeNodeOrChildNodeRemoval = function (c, b) {
      ...
      f.observe(c, {attributes: !1, childList: !0, characterData: !1, subtree: !0});
      return f
    }
  })(window, window.OTHelpers);
  (function (b, a, d) {
    a.Modal = function (b) {
      ...
      try {
        ...
        d.style.backgroundColor =
          "transparent", d.setAttribute("allowTransparency", "true")
      }
      d.scrolling = "no";
  ...
  (function (b, a, d) {
    ...
    function c(a, c) {
      var b = "border" === c ? "Width" : "", d = c + "Top" + b, e = c + "Right" + b, k = c + "Bottom" + b, b = c + "Left" + b;
      a[c] = (a[d] === a[e] === a[k] === a[b] ? [a[d]] : a[d] === a[k] && a[b] === a[e] ? [a[d], a[e]] :
          a[b] === a[e] ? [a[d], a[e], a[k]] : [a[d], a[e], a[k], a[b]]).join(" ")
    }

    function k(a) {
      var b = a.currentStyle, d = l(a, b, "fontSize", null), k;
    ...
    k.prototype = {constructor: k, getPropertyPriority: function () {
  ...
  (function (b, a, d) {
    a.addClass = function (c, b) {
      if (1 === c.nodeType) {
        var d = a.trim(b).split(/\s+/), g, h;
        if (a.supportsClassList()) {
          g = 0;
          for (h = d.length; g < h; ++g)c.classList.add(d[g])
        } else {
          if (!c.className && 1 === d.length)c.className = b; else {
            var m = " " + c.className + " ";
            g = 0;
  ...
  (function (b, a, d) {
    ...
    a.makeVisibleAndYield = function (c, b) {
      ...
      if (d)return a.applyCSS(d, {display: "block", visibility: "hidden"}, b)
    }
  })(window, window.OTHelpers);
  (function (b, a, d) {
    if (d = b.requestAnimationFrame || b.mozRequestAnimationFrame || b.webkitRequestAnimationFrame || b.msRequestAnimationFrame)d = a.bind(d, b); else {
      var l = 0, c = a.now();
      d = function (d) {
        var f = a.now(), g = Math.max(0, 16 - (f - l)), h = b.setTimeout(function () {
          d(f - c)
        }, g);
        l = f + g;
        return h
  ...
  (function (b, a, d) {
    ...
    a.getJSON = function (c, b, d) {
      b = b || {};
      var g = function (a, c) {
        if (a)d(a, c && c.target && c.target.responseText); else {
          var b;
          try {
      ...
      if (b.xdomainrequest)a.xdomainRequest(c, {method: "GET"}, g); else {
        var h = a.extend({Accept: "application/json"},
            b.headers || {});
        a.get(c, a.extend(b || {}, {headers: h}), g)
      }
    };
    a.xdomainRequest = function (a, b, d) {
      ...
      var h = new XDomainRequest, m = (b || {}).method;
      m ? (m = m.toUpperCase(), "GET" === m || "POST" === m ? (h.onload = function () {
        g(null, {target: {responseText: h.responseText, headers: {"content-type": h.contentType}}})
      }, h.onerror = function () {
        g(Error("XDomainRequest of " + a + " failed"))
      }, h.ontimeout = function () {
        g(Error("XDomainRequest of " + a + " timed out"))
      }, h.open(m,
        a), h.send(b.body && l(b.body))) : d(Error("HTTP method can only be "))) : d(Error("No HTTP method specified in options"))
    };
    a.request = function (c, b, d) {
      var g = new XMLHttpRequest, h = b || {};
      if (h.method) {
  ...
  !function (b) {
    ...
    OT.$.defineGetters = function (a, c, b) {
      var d = {};
      void 0 === b && (b = !1);
      for (var g in c)c.hasOwnProperty(g) && (d[g] = {get: c[g], enumerable: b});
      Object.defineProperties(a, d)
    };
    OT.Modal = OT.$.Modal;
    OT.$.useLogHelpers(OT);
    var a = !1, d = OT.setLogLevel;
    OT.setLogLevel = function (b) {
      OT.$.setLogLevel(b);
      b = d.call(OT, b);
      OT.shouldLog(OT.DEBUG) && !a && (OT.debug("OpenTok JavaScript library " + OT.properties.version), OT.debug("Release notes: " + OT.properties.websiteURL +
        "/opentok/webrtc/docs/js/release-notes.html"), OT.debug("Known issues: " + OT.properties.websiteURL + "/opentok/webrtc/docs/js/release-notes.html#knownIssues"), a = !0);
  ...
  !function () {
    var b = function (a) {
      ...
      var d = OT.$.createElement("link", {type: "text/css", media: "screen", rel: "stylesheet", href: c});
      a.appendChild(d);
    ...
    OT.Dialogs.Plugin.promptToInstall = function () {
      var a = new OT.$.Modal(b(function (b, h) {
        ...
        var n = OT.$.bind(l,
          ...
          return b
        }, r = q("Download plugin"), p = q("cancel", "small"), t = q("Refresh browser"), v, s, u;
        ...
        u = n("OT_dialog-centering", [n("OT_dialog-centering-child", [n("OT_root OT_dialog OT_dialog-plugin-prompt",
          [s, n("OT_dialog-messages", [n("OT_dialog-messages-main", "This app requires real-time communication")]), n("OT_dialog-section", [n("OT_dialog-single-button-with-title", [n("OT_dialog-button-title", [v, function () {
    ...
    OT.Dialogs.Plugin.promptToReinstall = function () {
      var a = new OT.$.Modal(b(function (c, b) {
        ...
        q = k("OT_dialog-centering", [k("OT_dialog-centering-child", [k("OT_ROOT OT_dialog OT_dialog-plugin-reinstall", [e, k("OT_dialog-messages", [k("OT_dialog-messages-main",
          "Reinstall Opentok Plugin"), k("OT_dialog-messages-minor", "Uh oh! Try reinstalling the OpenTok plugin again to enable real-time video communication for Internet Explorer.")]), k("OT_dialog-section", [k("OT_dialog-single-button", n)])])])]);
        d(b, [], function () {
    ...
    OT.Dialogs.Plugin.updateInProgress = function () {
      var a, c, h = 0, k = new OT.$.Modal(b(function (b, n) {
        var q = OT.$.bind(l, n), r;
        c = q("OT_dialog-plugin-upgrade-percentage", "0%", "strong");
        a = q("OT_dialog-progress-bar-fill");
        r = q("OT_dialog-centering",
          [q("OT_dialog-centering-child", [q("OT_ROOT OT_dialog OT_dialog-plugin-upgrading", [q("OT_dialog-messages", [q("OT_dialog-messages-main", ["One moment please... ", c]), q("OT_dialog-progress-bar", a), q("OT_dialog-messages-minor OT_dialog-no-natural-margin", "Please wait while the OpenTok plugin is updated")])])])]);
        d(n, [], function () {
      ...
      k.setUpdateProgress = function (b) {
        a && c ? 99 < b ? (OT.$.css(a, "width", ""), c.innerHTML = "100%") : 1 > b ? (OT.$.css(a, "width", "0%"),
          c.innerHTML = "0%") : (OT.$.css(a, "width", b + "%"), c.innerHTML = b + "%") : h = b
      };
      return k
    };
    OT.Dialogs.Plugin.updateComplete = function (a) {
      var c = new OT.$.Modal(b(function (b, k) {
        var e = OT.$.bind(l, k), n, q;
        ...
        q = e("OT_dialog-centering", [e("OT_dialog-centering-child",
          [e("OT_root OT_dialog OT_dialog-plugin-upgraded", [e("OT_dialog-messages", [e("OT_dialog-messages-main", r[0]), e("OT_dialog-messages-minor", r[1])]), e("OT_dialog-single-button", n)])])]);
        d(k, [], function () {
  ...
  !function (b) {
    ...
    OT.properties = function (a) {
      ...
      b.OTProperties && (b.OTProperties.cdnURL && (d.cdnURL = b.OTProperties.cdnURL),
        b.OTProperties.cdnURLSSL && (d.cdnURLSSL = b.OTProperties.cdnURLSSL), b.OTProperties.configURL && (d.configURL = b.OTProperties.configURL), b.OTProperties.assetURL && (d.assetURL = b.OTProperties.assetURL), b.OTProperties.cssURL && (d.cssURL = b.OTProperties.cssURL));
  ...
  !function () {
    OT.Config = function () {
      var b = !1, a = {}, d = {}, l, c = document.head || document.getElementsByTagName("head")[0], k, f = function () {
      ...
      h = {loadTimeout: 4E3, load: function (a) {
  ...
  (function (b) {
    if (void 0 === b.TBPlugin && void 0 !== b.OT) {
      var a = OT.$.browserVersion(), d = "IE" === a.browser && 8 <= a.version, l = !1, c = {isSupported: function () {
        return d
      }, isReady: function () {
        return l
      }};
      ...
      if (c.isSupported()) {
        var k = function (a, c) {
            ...
            if (a &&
              (f[a] && (clearTimeout(f[a]), delete f[a]), b[a]))try {
              delete b[a]
            } catch (c) {
              b[a] = void 0
            }
            ...
            this.onReady = function (a) {
              if (c.on)c.on(-1, {customEvent: m(f, this)});
            ...
            var l = document.createElement("div"), m = [], q = ['width\x3d"0" height\x3d"0"'], p, t;
            !0 !== d && q.push('visibility\x3d"hidden"');
            m.push('\x3cobject type\x3d"' + a + '" ' + q.join(" ") + "\x3e");
            for (var r in h)h.hasOwnProperty(r) && m.push('\x3cparam name\x3d"' +
              r + '" value\x3d"' + h[r] + '" /\x3e');
            ...
            g = q(B.mimeType, !1, {windowless: !1}, a);
            g.selectSources = function () {
              return this._.selectSources.apply(this._, arguments)
            };
            return g
          }, p = function (a) {
            return q(B.mimeType, !0, {windowless: !0}, function (b, d) {
            ...
            this.appendTo = function (c) {
              c && a._.parentNode !== c && (F("VideoContainer appendTo",
                c), c.appendChild(a._), this.parentElement = c)
            };
            ...
            var k = function () {
              ...
              for (var a = 0; a < g.length; ++a)d._.addIceCandidate(e,
                g[a], k, n)
            }, m = function () {
              var a = Array.prototype.slice.call(arguments), c = a.shift();
              setTimeout(function () {
            ...
            this.createOffer = function (a, b, h) {
              ...
              d._.createOffer(e, function (b, d) {
                a(new c.RTCSessionDescription({type: b, sdp: d}))
              }, b, h || {})
            };
            ...
            if (d._.initPeerConnection(e, a, b))d._.on(e, {addStream: function (a) {
              setTimeout(function () {
                if (this.onaddstream && OT.$.isFunction(this.onaddstream)) {
                  var c = x.fromJson(a, d);
                  m(this.onaddstream, {stream: c})
                }
              }.bind(this), 3E3)
            }.bind(this), removeStream: function (a) {
              this.onremovestream && OT.$.isFunction(this.onremovestream) && (a = x.fromJson(a, d), m(this.onremovestream, {stream: a}))
            }.bind(this), iceCandidate: function (a, b, d) {
              this.onicecandidate && OT.$.isFunction(this.onicecandidate) && (a = new c.RTCIceCandidate({candidate: a, sdpMid: b, sdpMLineIndex: d}), m(this.onicecandidate, {candidate: a}))
            }.bind(this), signalingStateChange: function (a) {
              this.onsignalingstatechange && OT.$.isFunction(this.onsignalingstatechange) && m(this.onsignalingstatechange, a)
            }.bind(this), iceConnectionChange: function (a) {
              this.oniceconnectionstatechange && OT.$.isFunction(this.oniceconnectionstatechange) && m(this.oniceconnectionstatechange, a)
            }.bind(this)}); else OT.error("Failed to initialise PeerConnection")
          },
          u = function (a, c, b) {
            this.id = c.id;
            this.kind = c.kind;
            ...
            this._ = {plugin: c, render: OT.$.bind(function () {
              return new t(c,
                this)
            }, this)}
          };
        ...
        (function () {
          var a, b, d = -1, e = function (a, c) {
            if (a === c)return!1;
            var b = a.split("."), d = c.split("."), b = parseFloat(parseInt(b.shift(), 10) + "." + b.map(function (a) {
              return parseInt(a, 10)
            }).join("")), d = parseFloat(parseInt(d.shift(), 10) + "." + d.map(function (a) {
              return parseInt(a,
                10)
            }).join(""));
            return b > d
            ...
            b =
                -1 !== d ? "application/x-otieplugininstaller,version\x3d" + d : null
          }, f = function () {
            void 0 === b && h();
            return b
          }, g = function () {
          ...
          y = function (a) {
            ...
            this.autoUpdate = function () {
              var b = OT.Dialogs.Plugin.updateInProgress(), d = new OT.Analytics, e = {ieVersion: OT.$.browserVersion().version, pluginOldVersion: c.installedVersion(), pluginNewVersion: c.version()}, h = m(function () {
                d.logEvent({action: "OTPluginAutoUpdate",
                  variation: "Success", partnerId: OT.APIKEY, payload: JSON.stringify(e)});
                a.destroy();
                b.close();
                OT.Dialogs.Plugin.updateComplete().on({reload: function () {
                  window.location.reload()
                }})
              }), f = m(function (c, h, f) {
                e.errorCode = c;
                e.systemErrorCode = f;
                d.logEvent({action: "OTPluginAutoUpdate", variation: "Failure", partnerId: OT.APIKEY, payload: JSON.stringify(e)});
                a.destroy();
                b.close();
                b = OT.Dialogs.Plugin.updateComplete(h + " (" + c + "). Please restart your browser and try again.").on({reload: function () {
                  b.close()
                }});
                OT.error("autoUpdate failed: " +
                  h + " (" + c + "). Please restart your browser and try again.")
              }), g = m(function (a) {
          ...
          y.get = function (c) {
            a ? c.call(null, void 0, a) : this.isinstalled() ? q(f(), !1, {windowless: !1}, function (b, d) {
              d && (a = new y(d));
              c.call(null, b, a)
        ...
        var B = {mimeType: "application/x-opentokie,version\x3d0.4.0.8",
            activeXName: "TokBox.OpenTokIE.0.4.0.8", version: "0.4.0.8"}, A = b.document, w = [], F = function (a, c) {
            c ? b.OT.info("TB Plugin - " + a + " \x3d\x3e ", c) : b.OT.info("TB Plugin - " + a)
          }, G = function () {
            var a = function (a) {
              for (var b; (b = w.pop()) && OT.$.isFunction(b);)b.call(c, a)
            };
            y.get(function (c, b) {
        ...
        (function () {
          Function.prototype.bind || (Function.prototype.bind = function (a) {
            ...
            var c = Array.prototype.slice.call(arguments, 1), b = this, d = function () {
            }, e = function () {
          ...
          Array.prototype.indexOf || (Array.prototype.indexOf = function (a, c) {
            ...
            d = this.length;
            if (0 === d || b >= d)return-1;
            for (0 > b && (b = d - Math.abs(b)); b <
              d; b++)if (this[b] === a)return b;
            return-1
          });
        ...
        (function () {
          "complete" === A.readyState || "interactive" === A.readyState && A.body ? G() : A.addEventListener ? A.addEventListener("DOMContentLoaded", G, !1) : A.attachEvent &&
  ...
  !function () {
    function b(a, c, b, f, g) {
      if (TBPlugin.isInstalled())OT.$.css(a, {width: "100%", height: "100%", left: 0, top: 0}); else if (c = c ? parseInt(c, 10) : parseInt(OT.$.width(a.parentNode), 10), b = b ? parseInt(b, 10) : parseInt(OT.$.height(a.parentNode), 10), !(0 === c || 0 === b))if (f || (f = d), b = (c + 0) / b, c = {width: "100%", height: "100%", left: 0, top: 0}, b > f ? (f = 100 * (b / f), c.height = f + "%", c.top = "-" + (f - 100) / 2 + "%") : b < f && (f = 100 * (f / b), c.width = f + "%", c.left = "-" + (f - 100) / 2 + "%"), OT.$.css(a, c), f = a.querySelector("video"))g ? (g = a.offsetWidth, a = a.offsetHeight,
        c = g - a, c = {width: a + "px", height: g + "px", marginTop: -(c / 2) + "px", marginLeft: c / 2 + "px"}, OT.$.css(f, c)) : OT.$.css(f, {width: "", height: "", marginTop: "", marginLeft: ""})
    }
    ...
    var d = 4 / 3, l = 128, c = 128, k = 64, f = 64, g = function (a, c) {
      var b, d;
      a && a.nodeName ? (b = a, (!b.getAttribute("id") || 0 === b.getAttribute("id").length) && b.setAttribute("id", "OT_" + OT.$.uuid()),
        d = b.getAttribute("id")) : (b = OT.$(a), d = a || "OT_" + OT.$.uuid());
      b ? null == c || "replace" === c ? OT.$.emptyElement(b) : (d = document.createElement("div"), d.id = "OT_" + OT.$.uuid(), "append" === c ? (b.appendChild(d), b = d) : "before" === c ? (b.parentNode.insertBefore(d, b), b = d) : "after" === c && (b.parentNode.insertBefore(d, b.nextSibling), b = d)) : (b = OT.$.createElement("div", {id: d}), b.style.backgroundColor = "#000000", document.body.appendChild(b));
      return b
    };
    OT.WidgetView = function (c, d) {
      var e = g(c, d && d.insertMode), f = document.createElement("div"),
        k, l, p, t, v, s, u = !0, x = !1;
      d && (v = d.width, s = d.height, v && "number" === typeof v && (v += "px"), s && "number" === typeof s && (s += "px"), e.style.width = v ? v : "264px", e.style.height = s ? s : "198px", e.style.overflow = "hidden", a(e, v || "264px", s || "198px"), (void 0 === d.mirror || d.mirror) && OT.$.addClass(e, "OT_mirrored"));
      ...
      TBPlugin.isInstalled() || (k = OT.$.observeStyleChanges(e, ["width", "height"], function (c) {
        ...
        l && (OT.$.some(a, function (a) {
          ...
          l = null), f && (OT.$.removeElement(f), f = null), k && (k.disconnect(), k = null), p && (p.disconnect(), p = null))
      }));
      this.destroy = function () {
      ...
      this.bindVideo = function (a, c, d) {
        ...
        g.appendTo(f).bindToStream(a, function (a) {
          if (a)g.destroy(), d(a); else {
            ...
            if (isNaN(l.aspectRatio()))l.on("streamBound", a); else a();
            d(null, g)
          }
        });
        return g
      ...
      OT.$.defineProperties(this, {showPoster: {get: function () {
      ...
      this.addError = function (a, c, b) {
        ...
        e.querySelector("p").offsetHeight > e.offsetHeight && (e.querySelector("span").style.display =
          "none")
      }
    }
  }(window);
  !function (b) {
    ...
    OT.$.createPeerConnection =
      function (b, l, c, k) {
        if (TBPlugin.isInstalled())TBPlugin.initPeerConnection(b, l, c, k); else {
          var f;
          try {
            f = new a(b, l)
          } catch (g) {
  ...
  !function (b) {
    ...
    OT.$.registerCapability("webrtc", function () {
      var a = OT.$.browserVersion(), b = (OT.properties.minimumVersion || {})[a.browser.toLowerCase()];
    ...
    OT.$.registerCapability("RTCPMux", function () {
      return OT.$.hasCapabilities("webrtc") &&
        ("Chrome" === OT.$.browser() || TBPlugin.isInstalled())
    });
  ...
  !function () {
    ...
    a = {PERMISSION_DENIED: "PermissionDeniedError", NOT_SUPPORTED_ERROR: "NotSupportedError", MANDATORY_UNSATISFIED_ERROR: " ConstraintNotSatisfiedError",
      NO_DEVICES_FOUND: "NoDevicesFoundError", HARDWARE_UNAVAILABLE: "HardwareUnavailableError", TrackStartError: "HardwareUnavailableError"};
    d = {PermissionDeniedError: "End-user denied permission to hardware devices", PermissionDismissedError: "End-user dismissed permission to hardware devices", NotSupportedError: "A constraint specified is not supported by the browser.", ConstraintNotSatisfiedError: "It's not possible to satisfy one or more constraints passed into the getUserMedia function", OverconstrainedError: "Due to changes in the environment, one or more mandatory constraints can no longer be satisfied.",
      NoDevicesFoundError: "No voice or video input devices are available on this machine.", HardwareUnavailableError: "The selected voice or video devices are unavailable. Verify that the chosen devices are not in use by another application."};
    l = function (a, c) {
      var b, k;
      b = c.hasOwnProperty(a) ? c[a] : a;
      k = d.hasOwnProperty(b) ? d[b] : "Unknown Error while getting user media";
      return{name: b, message: k}
    };
    c = function (c) {
      var b;
      OT.$.isObject(c) && c.name ? (b = l(c.name, a), b.constraintName = c.constraintName) : b = "string" === typeof c ? l(c,
        a) : {message: "Unknown Error type while getting media"};
      return b
    };
    k = function (a) {
    ...
    OT.$.getUserMedia = function (a, d, h, l, e, n, q) {
      var r = b;
      OT.$.isFunction(q) && (r = q);
      if (k(a))OT.error("Couldn't get UserMedia: All constraints were false"), h.call(null, {name: "NO_VALID_CONSTRAINTS", message: "Video and Audio was disabled, you need to enabled at least one"}); else {
        var p = null, t = !1;
        q = function () {
          p = null;
          t = !0;
  ...
  !function (b) {
    var a = {audio: "audioInput", video: "videoInput"};
    OT.$.shouldAskForDevices = function (a) {
      ...
      null != l && OT.$.isFunction(l.getSources) ? b.MediaStreamTrack.getSources(function (c) {
        ...
        a.call(null, {video: c, audio: b})
      }) : (OT.$.shouldAskForDevices = function (a) {
        setTimeout(OT.$.bind(a, null, {video: !0, audio: !0}))
      }, OT.$.shouldAskForDevices(a))
    };
    OT.$.getMediaDevices = function (d) {
      OT.$.hasCapabilities("getMediaDevices") ?
        b.MediaStreamTrack.getSources(function (b) {
          b = OT.$.filter(b, function (c) {
            return null != a[c.kind]
          });
          d(void 0, OT.$.map(b, function (c) {
            return{deviceId: c.id, label: c.label, kind: a[c.kind]}
          }))
  ...
  (function (b) {
    ...
    function l(a, e, h) {
      var f, g, k, l, m, x = OT.$.browserVersion(), x = "Chrome" === x.browser && 36 > x.version;
      navigator.mozGetUserMedia || !x || !(0 < e.getVideoTracks().length && e.getVideoTracks()[0].enabled) ? (f = function () {
        ...
        0 === a.currentTime ? (f(), h("The video stream failed to connect. Please notify the site owner if this continues to happen.")) : !0 === e.ended ? l() : (OT.warn("Never got the loadedmetadata event but currentTime \x3e 0"),
          g(null))
    ...
    var k = {"0": "rotate(0deg)", 270: "rotate(90deg)", 90: "rotate(-90deg)", 180: "rotate(180deg)"};
    OT.VideoOrientation = {ROTATED_NORMAL: 0, ROTATED_LEFT: 270,
      ROTATED_RIGHT: 90, ROTATED_UPSIDE_DOWN: 180};
    var f = 2 * Math.PI / 360;
    OT.VideoElement = function (a) {
      var c = OT.$.defaults(a && !OT.$.isFunction(a) ? a : {}, {fallbackText: "Sorry, Web RTC is not available in your browser"}), b = OT.$.isFunction(arguments[arguments.length - 1]) ? arguments[arguments.length - 1] : void 0, d = OT.$.bind(function (a) {
        this.trigger("orientationChanged", a)
      }, this), e = TBPlugin.isInstalled() ? new g(c, b, d) : new h(c, b, d), f = !1, k, l;
      OT.$.eventing(this);
      OT.$.defineProperties(this, {domElement: {get: function () {
        return e.domElement()
      }},
        ...
        }}, isRotated: {get: function () {
          return e.isRotated()
        }}, orientation: {get: function () {
          return e.orientation()
        }, set: function (a) {
          e.orientation(a)
        }}, audioChannelType: {get: function () {
    ...
    var g = function (a, c, b) {
      ...
      this.imgData = function () {
        var a = OT.$.createElement("canvas", {width: f.videoWidth, height: f.videoHeight, style: {display: "none"}});
      ...
      this.whenTimeIncrements = function (a, c) {
        if (f) {
          var b, d;
          d = OT.$.bind(function () {
            !b || b >= f.currentTime ? b = f.currentTime : (f.removeEventListener("timeupdate",
              d, !1), a.call(c, this))
          }, this);
      ...
      var e = d;
      OT.$.defineProperties(a, {isRotated: {get: function () {
        ...
        switch (OT.$.browser()) {
          ...
          case "Safari":
            ...
            break;
          case "IE":
            if (9 <= OT.$.browserVersion().version)c().style.msTransform = d; else {
        ...
        "mozAudioChannelType"in this.domElement &&
        (this.domElement.mozAudioChannelType = a)
      }}})
    }, e = {};
    b.MediaError && (e[b.MediaError.MEDIA_ERR_ABORTED] = "The fetching process for the media resource was aborted by the user agent at the user's request.", e[b.MediaError.MEDIA_ERR_NETWORK] = "A network error of some description caused the user agent to stop fetching the media resource, after the resource was established to be usable.", e[b.MediaError.MEDIA_ERR_DECODE] = "An error of some description occurred while decoding the media resource, after the resource was established to be  usable.",
      e[b.MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED] = "The media resource indicated by the src attribute was not suitable.")
  })(window);
  !function () {
    ...
    OT._.getClientGuid = function (l) {
      d(function (c, d) {
        c ? l(c) : (d ? a || (a = d) : (d = OT.$.uuid(), b.set(d,
          function (c) {
            c ? l(c) : a = d
          })), l(null, a))
      })
    };
    OT.overrideGuidStorage({get: function (a) {
  ...
  !function (b) {
    ...
    OT.Analytics = function () {
      var l = OT.properties.loggingURL + "/logging/ClientEvent", c = OT.properties.loggingURL + "/logging/ClientQos", k = {}, f, g = OT.$.browserVersion(), h = function (a, b, d) {
        OT.$.post((b ? c : l) + "?_\x3d" + OT.$.uuid.v4(), {body: a, xdomainrequest: "IE" === g.browser && 10 > g.version, headers: {"Content-Type": "application/x-www-form-urlencoded"}}, d)
      }, m = function () {
        if (!d && 0 < a.length) {
          d = !0;
          var c = a[0], b = function () {
            a.shift();
            d = !1;
            m()
          };
      ...
      this.logError = function (a, c, b, d, f) {
        f || (f = {});
        b = f.partnerId;
        if (!0 === OT.Config.get("exceptionLogging",
          "enabled", b)) {
          var h;
          b ? (h = [b, c, a].join("_"), h = 100 >= (k[h] || 0)) : h = !1;
          if (!h) {
            b = [b, c, a].join("_");
            var g = this.escapePayload(OT.$.extend(d || {}, {message: g, userAgent: OT.$.userAgent()}));
            k[b] = "undefined" !== typeof k[b] ? k[b] + 1 : 1;
            return this.logEvent(OT.$.extend(f, {action: c + "." + a, payloadType: g[0], payload: g[1]}))
          }
        }
      };
      this.logEvent = function (c) {
        ...
        OT._.getClientGuid(function (h, g) {
          if (!h) {
            var k = OT.$.extend({variation: "", guid: g, widget_id: "", session_id: "", connection_id: "", stream_id: "", partner_id: d,
              source: b.location.href, section: "", build: ""}, c), l;
            for (l in f)f.hasOwnProperty(l) && k[l] && (k[f[l]] = k[l], delete k[l]);
            a.push({data: k, onComplete: function () {
            }, isQos: !1});
            m()
          }
        })
      ...
      this.logQOS = function (c) {
        ...
        OT._.getClientGuid(function (h, g) {
          if (!h) {
            var k = OT.$.extend({guid: g, widget_id: "", session_id: "", connection_id: "", stream_id: "", partner_id: d, source: b.location.href, build: "", duration: 0}, c), l;
            for (l in f)f.hasOwnProperty(l) && (k[l] && (k[f[l]] = k[l]), delete k[l]);
            a.push({data: k, onComplete: function () {
            },
              isQos: !0});
  ...
  !function (b) {
    ...
    var a = new OT.Analytics, d, l = document.location.hash;
    ...
    OT.initPublisher = function (a, b, d, g) {
      ...
      if (null != a && !(OT.$.isElementNode(a) ||
        "string" === typeof a && document.getElementById(a)) && "function" !== typeof a)a = b, b = d, d = g;
    ...
    OT.checkSystemRequirements = function () {
      ...
      var c = OT.$.hasCapabilities("websockets", "webrtc") || TBPlugin.isInstalled(), c = c ? this.HAS_REQUIREMENTS : this.NOT_HAS_REQUIREMENTS;
      OT.checkSystemRequirements = function () {
        OT.debug("OT.checkSystemRequirements()");
        return c
      };
      c === this.NOT_HAS_REQUIREMENTS && a.logEvent({action: "checkSystemRequirements", variation: "notHasRequirements", payload_type: "userAgent", partner_id: OT.APIKEY, payload: OT.$.userAgent()});
      return c
    };
    OT.upgradeSystemRequirements = function () {
      OT.onLoad(function () {
        if (TBPlugin.isSupported())OT.Dialogs.Plugin.promptToInstall().on({download: function () {
          ...
          var d = OT.$.browserVersion(), d = OT.properties.minimumVersion[d.browser.toLowerCase()] > d.version;
          a.src = OT.properties.assetURL + "/html/upgrade.html#" + encodeURIComponent(d ? "true" : "false") + "," + encodeURIComponent(JSON.stringify(OT.properties.minimumVersion)) +
    ...
    OT.APIKEY = function () {
      var a = document.getElementsByTagName("script"),
        a = a[a.length - 1], a = a.getAttribute("src") || a.src;
  ...
  !function () {
    ...
    OT.Event.names = {ACTIVE: "active", INACTIVE: "inactive", UNKNOWN: "unknown", PER_SESSION: "perSession", PER_STREAM: "perStream", EXCEPTION: "exception", ISSUE_REPORTED: "issueReported", SESSION_CONNECTED: "sessionConnected", SESSION_DISCONNECTED: "sessionDisconnected", STREAM_CREATED: "streamCreated", STREAM_DESTROYED: "streamDestroyed", CONNECTION_CREATED: "connectionCreated", CONNECTION_DESTROYED: "connectionDestroyed", SIGNAL: "signal", STREAM_PROPERTY_CHANGED: "streamPropertyChanged",
      ...
      CLOSE_BUTTON_CLICK: "closeButtonClick", MICLEVEL: "microphoneActivityLevel", MICGAINCHANGED: "microphoneGainChanged", ENV_LOADED: "envLoaded", ENV_UNLOADED: "envUnloaded", AUDIO_LEVEL_UPDATED: "audioLevelUpdated"};
    OT.ExceptionCodes = {JS_EXCEPTION: 2E3, AUTHENTICATION_ERROR: 1004, INVALID_SESSION_ID: 1005, CONNECT_FAILED: 1006, CONNECT_REJECTED: 1007, CONNECTION_TIMEOUT: 1008, NOT_CONNECTED: 1010, P2P_CONNECTION_FAILED: 1013, API_RESPONSE_FAILURE: 1014, UNABLE_TO_PUBLISH: 1500, UNABLE_TO_SUBSCRIBE: 1501, UNABLE_TO_FORCE_DISCONNECT: 1520,
    ...
    OT.ConnectionEvent = function (a, d, f) {
      ...
      OT.$.canDefineProperty ? Object.defineProperty(this, "connections", {get: function () {
        b || (OT.warn("OT.ConnectionEvent connections property is deprecated, use connection instead."),
          b = !0);
        return[d]
      }}) : this.connections = [d];
      this.connection = d;
    ...
    OT.StreamEvent = function (b, d, f, g) {
      ...
      OT.$.canDefineProperty ? Object.defineProperty(this, "streams", {get: function () {
    ...
    OT.SessionConnectEvent = function (a) {
      OT.Event.call(this, a, !1);
      OT.$.canDefineProperty ? Object.defineProperties(this, {connections: {get: function () {
        d ||
        (OT.warn("OT.SessionConnectedEvent no longer includes connections. Listen for connectionCreated events instead."), d = !0);
        return[]
      }}, streams: {get: function () {
  ...
  (function (b) {
    ...
    function k(b) {
      var c = 0, d = function (b) {
        for (var c = [], d = 0, e = b.length; d < b.length;) {
          ...
          if (a(h, 55296, 57343))if (a(h, 56320, 57343))c.push(65533); else if (d === e - 1)c.push(65533); else {
    ...
    function r(b) {
      ...
      this.decode = function (b) {
        ...
        if (0 === e) {
          ...
          if (a(k, 194, 223))e = 1, g = 128, d = k - 192; else if (a(k, 224, 239))e = 2, g = 2048, d = k - 224; else if (a(k, 240, 244))e = 3, g = 65536, d = k - 240; else return h(c);
          d *= Math.pow(64, e);
          return null
        }
    ...
    function s(b, c) {
      ...
      this.decode = function (c) {
        ...
        if (0 !== k) {
          l = null;
          if (a(g, 48, 57))if (g = 10 * (126 * (10 * (e - 129) + (f - 48)) +
            (k - 129)) + g - 48, 39419 < g && 189E3 > g || 1237575 < g)l = null; else {
            var m = 0;
            l = 0;
            var q = D.gb18030, p;
            for (p = 0; p < q.length; ++p) {
              var K = q[p];
              if (K[0] <= g)m = K[0], l = K[1]; else break
            }
            l = l + g - m
          }
          k = f = e = 0;
        ...
        return a(g, 0, 127) ? g : 128 ===
          g ? 8364 : a(g, 129, 254) ? (e = g, null) : h(d)
      }
    }
    ...
    function u(b, c) {
      this.encode = function (c, e) {
        ...
        var g = h = 0, k = D.gb18030, l;
        for (l = 0; l < k.length; ++l) {
          var n = k[l];
          if (n[1] <= f)h = n[1], g = n[0]; else break
        }
        h = g + f - h;
        f = d(d(d(h, 10), 126), 10);
        h -= 12600 * f;
    ...
    function A(b) {
      ...
      this.decode = function (b) {
        ...
        b.offset(1);
        var g, k;
        return 0 !== e ? (g = e, e = 0, k = null, a(g, 161, 254) && a(f, 161, 254) && (k = n(94 * (g - 161) + f - 161, D.jis0212)), a(f, 161, 254) || b.offset(-1), null === k ? h(c) : k) : 142 === d && a(f, 161, 223) ? (d = 0, 65377 + f - 161) : 143 === d && a(f, 161, 254) ? (d = 0, e = f, null) : 0 !== d ? (g = d, d = 0, k = null, a(g, 161, 254) && a(f, 161, 254) && (k = n(94 * (g - 161) +
          f - 161, D.jis0208)), a(f, 161, 254) || b.offset(-1), null === k ? h(c) : k) : a(f, 0, 127) ? f : 142 === f || 143 === f || a(f, 161, 254) ? (d = f, null) : h(c)
      }
    }
    ...
    function F(b) {
      ...
      this.decode = function (b) {
        ...
        switch (d) {
          ...
          case 1:
            if (36 === g || 40 === g)return f = g, d = 2, null;
            -1 !== g && b.offset(-1);
            d = 0;
            return h(c);
          case 2:
            ...
            if (40 === k && 73 === g)return d = 6, null;
            -1 === g ? b.offset(-1) : b.offset(-2);
            d = 0;
            return h(c);
          case 3:
            if (68 === g)return e = !0, d = 4, null;
    ...
    function H(b) {
      ...
      this.decode = function (b) {
        ...
        if (0 !== d) {
          ...
          d = 0;
          if (a(e,
            64, 126) || a(e, 128, 252))return b = n(188 * (f - (160 > f ? 129 : 193)) + e - (127 > e ? 64 : 65), D.jis0208), null === b ? h(c) : b;
          b.offset(-1);
          return h(c)
        }
    ...
    function M(b) {
      ...
      this.decode = function (b) {
        ...
        switch (d) {
          ...
          case 1:
            if (36 === f)return d = 2, null;
            -1 !== f &&
            b.offset(-1);
            d = 0;
            return h(c);
          case 2:
            if (41 === f)return d = 3, null;
            -1 === f ? b.offset(-1) : b.offset(-2);
            d = 0;
            return h(c);
          case 3:
            if (67 === f)return d = 0, null;
            -1 === f ? b.offset(-2) : b.offset(-3);
            d = 0;
            return h(c);
          case 4:
    ...
    function O(b, c) {
      this.encode = function (c, e) {
        ...
        var g = d(h - 65536, 1024) + 55296, h = (h - 65536) % 1024 + 56320;
        f(g);
        return f(h)
      }
    }
    ...
    function L(a, c) {
      ...
      this._streaming = !1;
      this._encoder = null;
      this._options = {fatal: Boolean(c.fatal)};
    ...
    function N(a, c) {
      ...
      this._decoder = null;
      this._options = {fatal: Boolean(c.fatal)};
      Object.defineProperty ? Object.defineProperty(this, "encoding", {get: function () {
        return this._encoding.name
      }}) : this.encoding =
        this._encoding.name;
      return this
    ...
    if ((!Q || !("IE" === Q.browser && 10 > Q.version)) && !(void 0 !== b.TextEncoder && void 0 !== b.TextDecoder)) {
      ...
      [
        ...
        {encodings: [
          {labels: ["cp864", "ibm864"], name: "ibm864"},
          {labels: ["cp866", "ibm866"], name: "ibm866"},
          {labels: "csisolatin2 iso-8859-2 iso-ir-101 iso8859-2 iso_8859-2 l2 latin2".split(" "), name: "iso-8859-2"},
          {labels: "csisolatin3 iso-8859-3 iso_8859-3 iso-ir-109 l3 latin3".split(" "),
            name: "iso-8859-3"},
          {labels: "csisolatin4 iso-8859-4 iso_8859-4 iso-ir-110 l4 latin4".split(" "), name: "iso-8859-4"},
          {labels: ["csisolatincyrillic", "cyrillic", "iso-8859-5", "iso_8859-5", "iso-ir-144"], name: "iso-8859-5"},
          {labels: "arabic csisolatinarabic ecma-114 iso-8859-6 iso_8859-6 iso-ir-127".split(" "), name: "iso-8859-6"},
          {labels: "csisolatingreek ecma-118 elot_928 greek greek8 iso-8859-7 iso_8859-7 iso-ir-126".split(" "), name: "iso-8859-7"},
          {labels: "csisolatinhebrew hebrew iso-8859-8 iso-8859-8-i iso-ir-138 iso_8859-8 visual".split(" "),
            name: "iso-8859-8"},
          {labels: "csisolatin6 iso-8859-10 iso-ir-157 iso8859-10 l6 latin6".split(" "), name: "iso-8859-10"},
          {labels: ["iso-8859-13"], name: "iso-8859-13"},
          {labels: ["iso-8859-14", "iso8859-14"], name: "iso-8859-14"},
          ...
          {labels: ["windows-1251", "x-cp1251"], name: "windows-1251"},
          {labels: "ascii ansi_x3.4-1968 csisolatin1 iso-8859-1 iso8859-1 iso_8859-1 l1 latin1 us-ascii windows-1252".split(" "), name: "windows-1252"},
          {labels: ["cp1253", "windows-1253"], name: "windows-1253"},
          {labels: "csisolatin5 iso-8859-9 iso-ir-148 l5 latin5 windows-1254".split(" "), name: "windows-1254"},
          {labels: ["cp1255", "windows-1255"], name: "windows-1255"},
          {labels: ["cp1256",
            "windows-1256"], name: "windows-1256"},
          {labels: ["windows-1257"], name: "windows-1257"},
          {labels: ["cp1258", "windows-1258"], name: "windows-1258"},
          {labels: ["x-mac-cyrillic", "x-mac-ukrainian"], name: "x-mac-cyrillic"}
        ], heading: "Legacy single-byte encodings"},
        {encodings: [
          {labels: "chinese csgb2312 csiso58gb231280 gb2312 gbk gb_2312 gb_2312-80 iso-ir-58 x-gbk".split(" "), name: "gbk"},
        ...
        {encodings: [
          ...
          {labels: "csshiftjis ms_kanji shift-jis shift_jis sjis windows-31j x-sjis".split(" "), name: "shift_jis"}
        ...
        {encodings: [
          {labels: ["utf-16", "utf-16le"], name: "utf-16"},
      ...
      L.prototype = {encode: function (a, b) {
        a = a ? String(a) : "";
        b = Object(b);
        ...
        if (!this._streaming) {
          var h;
          do h = this._encoder.encode(e, f); while (-1 !== h);
          this._encoder = null
        }
        return new Uint8Array(d)
      }};
      N.prototype = {decode: function (a, b) {
        ...
        this._streaming = Boolean(b.stream);
        var c = new Uint8Array(a.buffer, a.byteOffset, a.byteLength), c = new l(c);
        if (!this._BOMseen) {
          this._BOMseen = !0;
        ...
        if (!this._streaming) {
          do e = this._decoder.decode(c), null !== e && -1 !== e && d.emit(e); while (-1 !== e && -1 != c.get());
          this._decoder = null
        }
        return d.string()
      }};
  ...
  !function () {
    OT.Rumor = {MessageType: {SUBSCRIBE: 0, UNSUBSCRIBE: 1, MESSAGE: 2, CONNECT: 3, DISCONNECT: 4, PING: 7, PONG: 8, STATUS: 9}}
  }(this);
  !function (b) {
    var a;
    a = {1002: "The endpoint is terminating the connection due to a protocol error. (CLOSE_PROTOCOL_ERROR)", 1003: "The connection is being terminated because the endpoint received data of a type it cannot accept (for example, a text-only endpoint received binary data). (CLOSE_UNSUPPORTED)", 1004: "The endpoint is terminating the connection because a data frame was received that is too large. (CLOSE_TOO_LARGE)", 1005: "Indicates that no status code was provided even though one was expected. (CLOSE_NO_STATUS)",
    ...
    b.Rumor.Socket = function (d, l, c) {
      var k, f, g, h, m, e,
        n, q, r, p, t = b.$.statable(this, ["disconnected", "error", "connected", "connecting", "disconnecting"], "disconnected", function (c) {
          switch (c) {
            case "disconnected":
            case "error":
              if (k = null, m) {
          ...
          h && h(a)
        }, this), u = b.$.bind(function () {
          this.is("connected") && ((!r ? 0 : 44900 <= b.$.now() - r) ? B({code: 4001}) : (k.send(b.Rumor.Message.Ping()), p = setTimeout(u, 9E3)))
        }, this), x = b.$.bind(function () {
          q && clearTimeout(q);
      ...
      this.publish = function (a, c, d) {
        k.send(b.Rumor.Message.Publish(a,
          c, d))
      };
      ...
      this.connect = function (a, e) {
        if (this.is("connecting", "connected"))e(new b.Rumor.SocketError(null, "Rumor.Socket cannot connect when it is already connecting or connected.")); else {
          f = a;
          n = e;
          t("connecting");
          var h = c || window.WebSocket, g = {onOpen: x, onClose: B, onError: y, onMessage: A};
          try {
            k = "undefined" !== typeof h ? new b.Rumor.NativeSocket(h, d, g) : new b.Rumor.PluginSocket(d, g),
              q = setTimeout(E, b.Rumor.Socket.CONNECT_TIMEOUT)
          } catch (l) {
      ...
      b.$.defineProperties(this, {id: {get: function () {
        return f
      }}, onOpen: {set: function (a) {
        v("onOpen", a);
        g = a
      }, get: function () {
        return g
      }},
        onError: {set: function (a) {
          v("onError", a);
          h = a
        }, get: function () {
          return h
        }}, onClose: {set: function (a) {
          v("onClose", a);
          m = a
        }, get: function () {
          return m
        }}, onMessage: {set: function (a) {
          v("onMessage", a);
          e = a
        }, get: function () {
          return e
  ...
  !function () {
    OT.Rumor.PluginSocket = function (b, a) {
      ...
      TBPlugin.initRumorSocket(b, OT.$.bind(function (b, k) {
        b ? (l = "closed", a.onClose({code: 4999})) : "initializing" === l ? (d = k, d.onOpen(function () {
          l = "open";
          a.onOpen()
  ...
  !function () {
    ...
    OT.Rumor.Message.prototype.serialize = function () {
      var b = 8, a = 7, d = [], l = [], c = [], k, f, g;
      a++;
      for (f = 0; f < this.toAddress.length; f++)d.push((new TextEncoder("utf-8")).encode(this.toAddress[f])), a += 2, a += d[f].length;
      a++;
      f = 0;
      for (k in this.headers)this.headers.hasOwnProperty(k) && (l.push((new TextEncoder("utf-8")).encode(k)),
        c.push((new TextEncoder("utf-8")).encode(this.headers[k])), a += 4, a += l[f].length, a += c[f].length, f++);
      k = (new TextEncoder("utf-8")).encode(this.data);
      var a = a + k.length, h = new ArrayBuffer(a), m = new Uint8Array(h, 0, a), a = a - 4;
      m[0] = (a & 4278190080) >>> 24;
      m[1] = (a & 16711680) >>> 16;
      m[2] = (a & 65280) >>> 8;
      m[3] = (a & 255) >>> 0;
    ...
    OT.Rumor.Message.deserialize = function (b) {
      if ("undefined" !== typeof Buffer && Buffer.isBuffer(b)) {
        var a = b, d = new ArrayBuffer(a.length), l = new Uint8Array(d);
        for (b = 0; b < a.length; ++b)l[b] = a[b];
        b = d
      }
      var c = 8, k = new Uint8Array(b), f, g, h, m, e, a = k[6], l = [];
      for (e = 0; e < k[7]; e++)m = k[c++] << 8, m += k[c++], f = new Uint8Array(b,
        c, m), l[e] = (new TextDecoder("utf-8")).decode(f), c += m;
      g = k[c++];
      d = {};
    ...
    OT.Rumor.Message.Connect = function (b, a) {
      return new OT.Rumor.Message(OT.Rumor.MessageType.CONNECT, [], {uniqueId: b, notifyDisconnectAddress: a},
        "")
    };
  ...
  !function () {
    OT.Raptor = {Actions: {CONNECT: 100, CREATE: 101, UPDATE: 102, DELETE: 103, STATE: 104, FORCE_DISCONNECT: 105, FORCE_UNPUBLISH: 106, SIGNAL: 107, CREATE_ARCHIVE: 108, CLOSE_ARCHIVE: 109, START_RECORDING_SESSION: 110, STOP_RECORDING_SESSION: 111, START_RECORDING_STREAM: 112, STOP_RECORDING_STREAM: 113, LOAD_ARCHIVE: 114, START_PLAYBACK: 115, STOP_PLAYBACK: 116, APPSTATE_PUT: 117, APPSTATE_DELETE: 118, OFFER: 119, ANSWER: 120, PRANSWER: 121, CANDIDATE: 122, SUBSCRIBE: 123, UNSUBSCRIBE: 124, QUERY: 125, SDP_ANSWER: 126, PONG: 127, REGISTER: 128, QUALITY_CHANGED: 129},
      Types: {RPC_REQUEST: 100, RPC_RESPONSE: 101, STREAM: 102, ARCHIVE: 103, CONNECTION: 104, APPSTATE: 105, CONNECTIONCOUNT: 106, MODERATION: 107, SIGNAL: 108, SUBSCRIBER: 110, JSEP: 109}}
  }(this);
  !function () {
    ...
    OT.Raptor.Message.connections.create = function (b, a, d) {
      return OT.Raptor.serializeMessage({method: "create", uri: "/v2/partner/" + b + "/session/" +
        a + "/connection/" + d, content: {userAgent: OT.$.userAgent()}})
    };
    OT.Raptor.Message.connections.destroy = function (b, a, d) {
      return OT.Raptor.serializeMessage({method: "delete", uri: "/v2/partner/" + b + "/session/" + a + "/connection/" + d, content: {}})
    };
    OT.Raptor.Message.sessions = {};
    OT.Raptor.Message.sessions.get = function (b, a) {
      return OT.Raptor.serializeMessage({method: "read", uri: "/v2/partner/" + b + "/session/" + a, content: {}})
    };
    OT.Raptor.Message.streams = {};
    OT.Raptor.Message.streams.get = function (b, a, d) {
      return OT.Raptor.serializeMessage({method: "read",
        uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d, content: {}})
    };
    OT.Raptor.Message.streams.create = function (b, a, d, l, c, k, f, g, h, m, e, n) {
      var q = [];
      void 0 !== g && q.push({id: "audio1", type: "audio", active: g});
      void 0 !== h && (c = {id: "video1", type: "video", active: h, width: k, height: f, orientation: c}, m && (c.frameRate = m), q.push(c));
      l = {id: d, name: l, channel: q};
      e && (l.minBitrate = e);
      n && (l.maxBitrate = n);
      return OT.Raptor.serializeMessage({method: "create", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d, content: l})
    };
    OT.Raptor.Message.streams.destroy =
      function (b, a, d) {
        return OT.Raptor.serializeMessage({method: "delete", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d, content: {}})
      };
    OT.Raptor.Message.streams.offer = function (b, a, d, l) {
      return OT.Raptor.serializeMessage({method: "offer", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d, content: {sdp: l}})
    };
    OT.Raptor.Message.streams.answer = function (b, a, d, l) {
      return OT.Raptor.serializeMessage({method: "answer", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d, content: {sdp: l}})
    };
    OT.Raptor.Message.streams.candidate =
      function (b, a, d, l) {
        return OT.Raptor.serializeMessage({method: "candidate", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d, content: l})
      };
    OT.Raptor.Message.streamChannels = {};
    OT.Raptor.Message.streamChannels.update = function (b, a, d, l, c) {
      return OT.Raptor.serializeMessage({method: "update", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/channel/" + l, content: c})
    };
    OT.Raptor.Message.subscribers = {};
    OT.Raptor.Message.subscribers.create = function (b, a, d, l, c, k) {
      c = {id: l, connection: c, keyManagementMethod: OT.$.supportedCryptoScheme(),
        bundleSupport: OT.$.hasCapabilities("bundle"), rtcpMuxSupport: OT.$.hasCapabilities("RTCPMux")};
      k && (c.channel = k);
      return OT.Raptor.serializeMessage({method: "create", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l, content: c})
    };
    OT.Raptor.Message.subscribers.destroy = function (b, a, d, l) {
      return OT.Raptor.serializeMessage({method: "delete", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l, content: {}})
    };
    OT.Raptor.Message.subscribers.update = function (b, a, d, l, c) {
      return OT.Raptor.serializeMessage({method: "update",
        uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l, content: c})
    };
    OT.Raptor.Message.subscribers.candidate = function (b, a, d, l, c) {
      return OT.Raptor.serializeMessage({method: "candidate", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l, content: c})
    };
    OT.Raptor.Message.subscribers.offer = function (b, a, d, l, c) {
      return OT.Raptor.serializeMessage({method: "offer", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l, content: {sdp: c}})
    };
    OT.Raptor.Message.subscribers.answer = function (b, a, d, l, c) {
      return OT.Raptor.serializeMessage({method: "answer", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l, content: {sdp: c}})
    };
    OT.Raptor.Message.subscriberChannels = {};
    OT.Raptor.Message.subscriberChannels.update = function (b, a, d, l, c, k) {
      return OT.Raptor.serializeMessage({method: "update", uri: "/v2/partner/" + b + "/session/" + a + "/stream/" + d + "/subscriber/" + l + "/channel/" + c, content: k})
    };
    ...
    OT.Raptor.Message.signals.create = function (b, a, d, l, c) {
      ...
      void 0 !== l && (k.type =
        l);
      void 0 !== c && (k.data = c);
      return OT.Raptor.serializeMessage({method: "signal", uri: "/v2/partner/" + b + "/session/" + a + (void 0 !== d ? "/connection/" + d : "") + "/signal/" + OT.$.uuid(), content: k})
    }
  }(this);
  !function () {
    OT.Signal = function (b, a, d) {
      a = function (a) {
        var b = null;
        null === a || void 0 === a ? b = {code: 400, reason: "The signal type was null or undefined. Either set it to a String value or omit it"} : 128 < a.length ? b = {code: 413, reason: "The signal type was too long, the maximum length of it is 128 characters"} : /^[a-zA-Z0-9\-\._~]+$/.exec(a) || (b = {code: 400, reason: "The signal type was invalid, it can only contain letters, numbers, '-', '_', and '~'."});
        return b
      };
      var l = function (a) {
        var b = null;
        if (null === a || void 0 === a)b =
        {code: 400, reason: "The signal data was null or undefined. Either set it to a String value or omit it"}; else try {
          8192 < JSON.stringify(a).length && (b = {code: 413, reason: "The data field was too long, the maximum size of it is 8192 characters"})
        } catch (d) {
      ...
      this.error =
        null;
      d && (d.hasOwnProperty("data") && (this.data = OT.$.clone(d.data), this.error = l(this.data)), d.hasOwnProperty("to") && (this.to = d.to, this.error || (this.error = !this.to ? {code: 400, reason: "The signal type was null or an empty String. Either set it to a non-empty String value or omit it"} : !(this.to instanceof OT.Connection || this.to instanceof OT.Session) ? {code: 400, reason: "The To field was invalid"} : null)), d.hasOwnProperty("type") && (this.error || (this.error = a(d.type)), this.type = d.type));
  ...
  !function () {
    ...
    OT.Raptor.Socket = function (a, d, l, c) {
      var k, f, g, h, m, e = OT.$.statable(this, ["disconnected", "connecting", "connected", "error", "disconnecting"], "disconnected"), n = function (a) {
      ...
      this.connect = function (a, b, c) {
        if (this.is("disconnected",
          ...
          g.connect(a, OT.$.bind(function (a) {
            a ? (a.message = "WebSocketConnection:" + a.code + ":" + a.message, n(a)) : (g.onError(r), OT.debug("Raptor Socket connected. Subscribing to " + s + " on " + d), g.subscribe([s]), a = OT.Raptor.Message.connections.create(OT.APIKEY, k, g.id()), this.publish(a, {"X-TB-TOKEN-AUTH": f}, OT.$.bind(function (a) {
              a ? (a.message =
                "ConnectToSession:" + a.code + ":Received error response to connection create message.", n(a)) : this.publish(OT.Raptor.Message.sessions.get(OT.APIKEY, k), function (a) {
      ...
      this.publish = function (a, b, c) {
        if (g.isNot("connected"))OT.error("OT.Raptor.Socket: cannot publish until the socket is connected." + a); else {
          var d = OT.$.uuid(), e = {}, f;
          ...
          OT.debug(a);
          g.publish([l], a, OT.$.extend(e, {"Content-Type": "application/x-raptor+v2", "TRANSACTION-ID": d, "X-TB-FROM-ADDRESS": g.id()}));
          return d
        }
      };
      this.streamCreate = function (a, b, c, d, e, f, h, g, l, m) {
        var n = OT.$.uuid();
        a = OT.Raptor.Message.streams.create(OT.APIKEY,
          k, n, a, b, c, d, e, f, h, g, l);
      ...
      this.jsepCandidate = function (a, b) {
        this.publish(OT.Raptor.Message.streams.candidate(OT.APIKEY,
          k, a, b))
      };
      ...
      this.jsepAnswerP2p = function (a, b, c) {
        this.publish(OT.Raptor.Message.subscribers.answer(OT.APIKEY,
          k, a, b, c))
      };
      ...
      switch (b.method) {
        case "updated":
          this.emit("streamChannel#updated",
            b.params.stream, b.params.channel, b.content);
          break;
        default:
          OT.warn("OT.Raptor.dispatch: " + b.signature + " is not currently implemented")
      }
    ...
    OT.Raptor.Dispatcher.prototype.dispatchSubscriberChannel = function (b) {
      switch (b.method) {
        case "updated":
          ...
          break;
        case "update":
          this.emit("subscriberChannel#update", b.params.subscriber,
            b.params.stream, b.content);
          break;
        default:
          OT.warn("OT.Raptor.dispatch: " + b.signature + " is not currently implemented")
      }
    ...
    OT.Raptor.Dispatcher.prototype.dispatchArchive = function (b) {
      switch (b.method) {
        case "created":
          ...
          break;
        case "updated":
          this.emit("archive#updated", b.params.archive,
            b.content)
      }
    }
  }(this);
  (function (b) {
    ...
    b.OT.SessionDispatcher = function (a) {
      ...
      b.on("stream#updated", function (b, c) {
        var d = a.streams.get(b);
        d ? d._.update(c) : OT.error("OT.Raptor.dispatch: A stream does not exist with the id of " +
          b + ", for stream#updated message!")
      });
      ...
      var m = function (a, b, c, d) {
        ...
        switch (a) {
          case "offer":
            h = [];
            (b = OT.subscribers.find({streamId: b})) && h.push(b);
            break;
          case "answer":
          case "pranswer":
          case "generateoffer":
          case "unsubscribe":
            h = OT.publishers.where({streamId: b});
            break;
          case "candidate":
            h =
              OT.publishers.where({streamId: b}).concat(OT.subscribers.where({streamId: b}));
            break;
          default:
        ...
        if (0 !== h.length) {
          ...
          if (!f && c.match(/^symphony\./))f = OT.Connection.fromHash({id: c, creationTime: Math.floor(OT.$.now())}), h[0].session.connections.add(f); else if (!f) {
      ...
      b.on("subscriberChannel#updated", function (b, c, d) {
        !b || !a.streams.has(b) ? OT.error("OT.Raptor.dispatch: Unable to determine streamId, or the stream does not exist, for subscriberChannel#updated message!") :
          a.streams.get(b)._.updateChannel(c, d)
      });
      ...
      b.on("subscriber#created", function (b, c, d) {
        (b = b ? a.streams.get(b) :
          null) ? a._.subscriberMap[c + "_" + b.id] = d : OT.error("OT.Raptor.dispatch: Unable to determine streamId, or the stream does not exist, for subscriber#created message!")
      });
      ...
      b.on("signal", function (b, d, f) {
        if (c) {
          ...
          h.push.apply(h, arguments), k.push(h))
      });
  ...
  !function () {
    var b = new function () {
      var a = !1, b = TBPlugin.isSupported(), l = b ? TBPlugin.isReady() : !0, c = function () {
        ...
        a = !0;
        OT.Config.off("dynamicConfigChanged",
          g);
      ...
      this.onLoad = function (b, c) {
        if (!OT.$.isDOMUnloaded() && OT.$.isReady() && a && l)b.call(c); else OT.on(OT.Event.names.ENV_LOADED, b, c)
      };
      this.onUnload = function (a, b) {
        if (this.isUnloaded())a.call(b); else OT.on(OT.Event.names.ENV_UNLOADED, a, b)
      };
      this.isUnloaded =
        function () {
  ...
  !function () {
    ...
    var b = {1004: "Authentication error", 1005: "Invalid Session ID", 1006: "Connect Failed", 1007: "Connect Rejected", 1008: "Connect Time-out", 1009: "Security Error", 1010: "Not Connected", 1011: "Invalid Parameter", 1012: "Peer-to-peer Stream Play Failed", 1013: "Connection Failed", 1014: "API Response Failure", 1500: "Unable to Publish", 1520: "Unable to Force Disconnect", 1530: "Unable to Force Unpublish", 2E3: "Internal Error", 2001: "Embed Failed", 4E3: "WebSocket Connection Failed",
      4001: "WebSocket Network Disconnected"}, a;
    OT.handleJsException = function (d, l, c) {
      c = c || {};
      var k, f = c.session;
      f ? (k = {sessionId: f.sessionId}, f.isConnected() && (k.connectionId = f.connection.connectionId), c.target || (c.target = f)) : c.sessionId && (k = {sessionId: c.sessionId}, c.target || (c.target = null));
      c = c.target;
      f = b[l];
      k = k ? OT.$.clone(k) : {};
      ...
      try {
        a || (a = new OT.Analytics), a.logError(l, "tb.exception", f, {details: d}, k), OT.dispatchEvent(new OT.ExceptionEvent(OT.Event.names.EXCEPTION,
          d, f, l, c, c))
      } catch (g) {
    ...
    OT.dispatchError = function (a, b, c, k) {
      ...
      OT.handleJsException(b, a, {session: k})
    }
  }(window);
  !function () {
  ...
  !function () {
    ...
    OT.Connection.fromHash =
      function (b) {
        return new OT.Connection(b.id, b.creationTime, b.data, OT.$.extend(b.capablities || {}, {supportsWebRTC: !0}), b.permissions || [])
      }
  }(window);
  !function () {
  ...
  !function () {
    ...
    OT.Stream = function (a, d, l, c, k, f) {
      ...
      this.getChannel = function (a) {
        for (var b = 0; b < this.channel.length; ++b)if (this.channel[b].id ===
          a)return this.channel[b];
        return null
      };
      ...
      this._.updateProperty = OT.$.bind(function (a, c) {
        if (-1 === OT.$.arrayIndexOf(b, a))OT.warn('Unknown stream property "' + a + '" was modified to "' + c + '".'); else {
          var d = this[a];
          switch (a) {
            case "name":
              this[a] = c;
      ...
      this._.update = OT.$.bind(function (a) {
        for (var b in a)a.hasOwnProperty(b) && this._.updateProperty(b,
          a[b])
      }, this);
  ...
  !function () {
    ...
    OT.AnalyserAudioLevelSampler = function (b) {
      var a = this, d = null, l = null;
      this.webOTStream =
        null;
      this.sample = function (c) {
        if (!d && a.webOTStream) {
          var k = b.createMediaStreamSource(a.webOTStream), f = b.createAnalyser();
          k.connect(f);
          d = f;
  ...
  var findIndex = function (b, a, d) {
    ...
    return-1
  }, SDPHelpers = {getMLineIndex: function (b, a) {
    var d = "m\x3d" + a;
    ...
    b = b.split("\r\n");
    var l = SDPHelpers.getMLineIndex(b, a), c = -1 < l ? b[l] : void 0, k = [], f;
    ...
    0 < k.length && -1 < l && (b[l] = SDPHelpers.removeTypesFromMLine(c,
      k));
    return b.join("\r\n")
  ...
  !function (b) {
    ...
    var l = function (a) {
      ...
      -1 === b.sdp.indexOf("a\x3dcrypto") && (b.sdp = b.sdp.replace(/^c=IN(.*)$/gmi,
    ...
    OT.PeerConnection = function (b) {
      ...
      var t = OT.$.bind(function (a, b) {
        if (p.length)p[0](a, b)
      }, this), v = OT.$.bind(function (a, c) {
        d ? a.call(null, null, d) : (m.push(a), 1 < m.length || (OT.debug('Creating peer connection config "' + JSON.stringify(b) + '".'), (!b.iceServers || 0 === b.iceServers.length) && OT.error("No ice servers present"), OT.$.createPeerConnection(b, {optional: [
          {DtlsSrtpKeyAgreement: !0}
        ]}, c, OT.$.bind(s, this))))
      }, this), s = OT.$.bind(function (a, b) {
        if (a)G("Failed to create PeerConnection, exception: " +
          a.toString(), "NewPeerConnection"), m = []; else {
          ...
          void 0 !== d.oniceconnectionstatechange && (d.oniceconnectionstatechange = function (a) {
            "failed" === a.target.iceConnectionState && setTimeout(function () {
              "failed" === a.target.iceConnectionState &&
              G("The stream was unable to connect due to a network error. Make sure your connection isn't blocked by a firewall.", "ICEWorkflow")
            }, 5E3)
          });
        ...
        if ((a = "string" === typeof a ? a : a.target && a.target.signalingState ? a.target.signalingState : a.target.readyState) && a.toLowerCase() !== r)switch (r = a.toLowerCase(), OT.debug("PeerConnection.stateChange: " +
          r), r) {
          case "closed":
            u.call(this)
        }
        ...
        var c = new a({type: "offer", sdp: b.content.sdp}), f = function (a) {
        ...
        b.content.sdp ? (q = new a({type: "answer",
          sdp: b.content.sdp}), d.setRemoteDescription(q, function () {
      ...
      this.remoteStreams =
        function () {
          var a;
          if (d) {
            if (d.getRemoteStreams)a = d.getRemoteStreams(); else if (d.remoteStreams)a = d.remoteStreams; else throw Error("Invalid Peer Connection object implements no method for retrieving remote streams");
    ...
    var b = function (a, b, d, g) {
        ...
        if (a.result) {
          ...
          for (var c = 0; c < a.length; c++) {
            ...
            if (e.stat) {
              ...
              a:{
                l = e;
                if (l.stat("googFrameHeightSent"))d.videoBytesTransferred = l.stat("bytesSent"); else if (l.stat("googFrameHeightReceived"))d.videoBytesTransferred = l.stat("bytesReceived");
                else {
                  l = NaN;
                  break a
                }
              ...
              isNaN(l) || (d.avgVideoBitrate = l);
              a:{
                l = e;
                if (l.stat("audioInputLevel"))d.audioBytesTransferred = l.stat("bytesSent"); else if (l.stat("audioOutputLevel"))d.audioBytesTransferred = l.stat("bytesReceived"); else {
                  l = NaN;
                  break a
                }
                l = Math.round(8 * (d.audioBytesTransferred - (b.audioBytesTransferred || 0)) / d.deltaSecs)
              }
              isNaN(l) || (d.avgAudioBitrate = l);
              e = e.stat("googFrameRateSent") ? e.stat("googFrameRateSent") : e.stat("googFrameRateReceived") ?
                e.stat("googFrameRateReceived") : null;
      ...
      a.getStats(null, function (a) {
        a.forEach(function (a) {
          if ("true" === a.googActiveConnection)d.localCandidateType = a.googLocalCandidateType, d.remoteCandidateType = a.googRemoteCandidateType, d.transportType = a.googTransportType; else if (void 0 !== a.googFrameHeightSent || void 0 !== a.googFrameHeightReceived || void 0 !== d.videoBytesTransferred || void 0 !== a.googFrameRateSent) {
            var c = b.videoBytesTransferred || 0;
            a.googFrameHeightSent ?
              d.videoBytesTransferred = a.bytesSent : a.googFrameHeightReceived && (d.videoBytesTransferred = a.bytesReceived);
          ...
          } else c = b.audioBytesTransferred || 0, a.audioInputLevel ? d.audioBytesTransferred = a.bytesSent : a.audioOutputLevel && (d.audioBytesTransferred = a.bytesReceived), d.audioBytesTransferred && (a = d.audioBytesTransferred -
            c, d.avgAudioBitrate = Math.round(8 * a / d.deltaSecs))
        });
        g(null, d)
      }, function (a) {
        g(a)
      ...
      a.getStats(null, function (a) {
        for (var c in a)if (a.hasOwnProperty(c) && ("outboundrtp" === a[c].type || "inboundrtp" === a[c].type)) {
          var e = a[c];
          -1 !== e.id.indexOf("video") ? (e.bytesSent || e.bytesReceived ? (d.videoBytesTransferred = e.bytesSent || e.bytesReceived, e = Math.round(8 * (d.videoBytesTransferred - (b.videoBytesTransferred || 0)) / d.deltaSecs)) : e = NaN, isNaN(e) || (d.avgVideoBitrate = e)) : -1 !== e.id.indexOf("audio") && (e.bytesSent ||
            e.bytesReceived ? (d.audioBytesTransferred = e.bytesSent || e.bytesReceived, e = Math.round(8 * (d.audioBytesTransferred - (b.audioBytesTransferred || 0)) / d.deltaSecs)) : e = NaN, isNaN(e) || (d.avgAudioBitrate = e))
        }
        g(null, d)
      }, function (a) {
        g(a)
    ...
    OT.PeerConnection.QOS = function (a) {
      var b = OT.$.now(),
        d, g = OT.$.bind(function m(e) {
          if (d) {
            var g = OT.$.now(), g = {timeStamp: g, duration: Math.round(g - b), deltaSecs: (g - e.timeStamp) / 1E3};
      ...
      this.startCollecting = function (a) {
        a && a.getStats && (d = a, g({timeStamp: OT.$.now()}))
      };
  ...
  !function () {
    var b = {};
    OT.PeerConnections = {add: function (a, d, l) {
      a = a.id + "_" + d;
      (d = b[a]) || (d = b[a] = {count: 0, pc: new OT.PeerConnection(l)});
      d.count += 1;
      return d.pc
    }, remove: function (a, d) {
      var l = a.id + "_" + d, c = b[l];
      c && (c.count -= 1, 0 === c.count && (c.pc.disconnect(), delete b[l]))
    }}
  }(window);
  !function () {
    OT.PublisherPeerConnection = function (b, a, d, l) {
      var c, k = !1, f = a._.subscriberMap[b.id + "_" + d], g, h, m, e;
      g = function () {
        this.destroy();
        ...
        switch (b) {
          ...
          case OT.Raptor.Actions.PRANSWER:
            a.sessionInfo.p2pEnabled ?
              a._.jsepAnswerP2p(d, f, c.sdp) : a._.jsepAnswer(d, c.sdp);
            break;
      ...
      this.init = function (a) {
        c = OT.PeerConnections.add(b, d, {iceServers: a});
        c.on({close: g, error: h, qos: e}, this);
  ...
  !function () {
    OT.SubscriberPeerConnection = function (b, a, d, l, c) {
      ...
      q = OT.$.bind(function (b, c) {
        if (!g && (b === OT.Raptor.Actions.CANDIDATE || b === OT.Raptor.Actions.OFFER || b === OT.Raptor.Actions.ANSWER || b === OT.Raptor.Actions.PRANSWER))g = -1 !== (b === OT.Raptor.Actions.CANDIDATE ?
      ...
      this.init = function () {
        ...
        k.on({close: h, streamAdded: m, streamRemoved: e, error: n, qos: p}, this);
        var f = k.registerMessageDelegate(q);
        if (0 < k.remoteStreams().length)OT.$.forEach(k.remoteStreams(), m, this); else if (1 === f) {
          var g;
          if (c.subscribeToVideo || c.subscribeToAudio)f = d.getChannelsOfType("audio"), g = d.getChannelsOfType("video"), g = OT.$.map(f, function (a) {
            ...
            return{id: a.id,
              type: a.type, active: c.subscribeToVideo, restrictFrameRate: void 0 !== c.restrictFrameRate ? c.restrictFrameRate : !1}
          }));
  ...
  !function () {
    OT.Chrome = function (b) {
      ...
      b.parent && (OT.$.eventing(this), this.destroy = function () {
        ...
        if ("string" === typeof d && l)l.parent = this, l.appendTo(b.parent), a[d] = l, this[d] = l; else for (var c in d)if (d.hasOwnProperty(c)) {
          var k = c, f = d[c];
          f.parent = this;
          f.appendTo(b.parent);
          a[k] = f;
  ...
  !function () {
    OT.Chrome.BackingBar = function (b) {
      ...
      var d = b.nameMode, l = b.muteMode;
      OT.Chrome.Behaviour.Widget(this, {mode: a(), nodeName: "div", htmlContent: "", htmlAttributes: {className: "OT_bar OT_edge-bar-item"}});
  ...
  !function () {
    OT.Chrome.NamePanel = function (b) {
      ...
      OT.Chrome.Behaviour.Widget(this, {mode: b.mode, nodeName: "h1", htmlContent: a, htmlAttributes: {className: "OT_name OT_edge-bar-item"}})
    }
  }(window);
  !function () {
    OT.Chrome.MuteButton = function (b) {
      var a, d = b.muted || !1, l, c;
      l = OT.$.bind(function () {
      ...
      OT.$.defineProperties(this, {muted: {get: function () {
        return d
      }, set: function (a) {
        d = a;
        l()
      }}});
      OT.Chrome.Behaviour.Widget(this, {mode: b.mode, nodeName: "button", htmlContent: "Mute", htmlAttributes: {className: d ? "OT_edge-bar-item OT_mute OT_active" :
        "OT_edge-bar-item OT_mute"}, onCreate: OT.$.bind(function (b) {
        a = OT.$.bind(c, this);
        OT.$.on(b, "click", a)
      }, this), onDestroy: OT.$.bind(function (b) {
        a = null;
        OT.$.off(b, "click", a)
      }, this)})
    }
  ...
  !function () {
    OT.Chrome.Archiving = function (b) {
      var a = b.archiving, d = b.archivingStarted || "Archiving on", l = b.archivingEnded || "Archiving off", c = !0, k, f, g, h, m, e, n;
      e = function (a) {
        h.nodeValue = a;
      ...
      n = OT.$.bind(function () {
        ...
        b.show && a ? (e(d), OT.$.addClass(g, "OT_mode-on"), OT.$.removeClass(g,
          "OT_mode-auto"), this.setDisplayMode("on"), m = setTimeout(function () {
      ...
      OT.Chrome.Behaviour.Widget(this, {mode: a && b.show && "on" || "off", nodeName: "h1", htmlAttributes: {className: "OT_archiving OT_edge-bar-item OT_edge-bottom"},
        onCreate: OT.$.bind(function () {
          k = OT.$.createElement("div", {className: "OT_archiving-light-box"}, "");
          f = OT.$.createElement("div", {className: "OT_archiving-light"}, "");
          k.appendChild(f);
          g = OT.$.createElement("div", {className: "OT_archiving-status OT_mode-on OT_edge-bar-item OT_edge-bottom"}, "");
  ...
  !function () {
    OT.Chrome.AudioLevelMeter = function (b) {
      var a = this, d, l, c, k, f = b.maxValue || 1, g = b.minValue || 0;
      OT.Chrome.Behaviour.Widget(this, {mode: b ? b.mode : "auto", nodeName: "div", htmlAttributes: {className: "OT_audio-level-meter"}, onCreate: function () {
        d = OT.$.createElement("div", {className: "OT_audio-level-meter__bar"}, "");
        c = OT.$.createElement("div", {className: "OT_audio-level-meter__value"}, "");
        l = OT.$.createElement("div", {className: "OT_audio-level-meter__audio-only-img"}, "");
  ...
  !function () {
    OT.Chrome.VideoDisabledIndicator = function (b) {
      ...
      OT.Chrome.Behaviour.Widget(this,
        {mode: a, nodeName: "div", htmlAttributes: {className: "OT_video-disabled-indicator"}});
  ...
  (function () {
    ...
    var b = function (a, b) {
      var l = {}, c, k, f, g;
      c = ["showMicButton", "showSpeakerButton",
        "nameDisplayMode", "buttonDisplayMode", "backgroundImageURI"];
      k = {buttonDisplayMode: ["auto", "mini", "mini-auto", "off", "on"], nameDisplayMode: ["auto", "off", "on"], audioLevelDisplayMode: ["auto", "off", "on"], showSettingsButton: [!0, !1], showMicButton: [!0, !1], backgroundImageURI: null, showControlBar: [!0, !1], showArchiveStatus: [!0, !1], videoDisabledDisplayMode: ["auto", "off", "on"]};
      f = function (a, b) {
      ...
      this.set = function (a, c) {
        ...
        var e = g(c), k;
        if (!f(a, e))return OT.warn("Style.set::Invalid style property passed " +
          a + " : " + e), this;
        k = l[a];
        e !== k && (l[a] = e, b(a, c, k));
        return this
  ...
  !function (b, a) {
    a.generateSimpleStateMachine = function (b, l, c) {
      var k = l.slice(), f = a.$.clone(c);
      return function (c) {
        function h(a, b) {
          c({message: a, newState: b, currentState: l, previousState: e})
        }
        ...
        this.set = function (b) {
          var c;
          -1 !== a.$.arrayIndexOf(k, b) ? f[l] && -1 !== a.$.arrayIndexOf(f[l], b) ? c = !0 : (h("'" + l + "' cannot transition to '" + b + "'", b), c = !1) : (h("'" + b + "' is not a valid state", b), c = !1);
  ...
  !function () {
    OT.SubscribingState = OT.generateSimpleStateMachine("NotSubscribing", "NotSubscribing Init ConnectingToPeer BindingRemoteStream Subscribing Failed Destroyed".split(" "), {NotSubscribing: ["NotSubscribing", "Init", "Destroyed"], Init: ["NotSubscribing", "ConnectingToPeer", "BindingRemoteStream", "Destroyed"], ConnectingToPeer: ["NotSubscribing", "BindingRemoteStream", "Failed", "Destroyed"], BindingRemoteStream: ["NotSubscribing", "Subscribing", "Failed", "Destroyed"], Subscribing: ["NotSubscribing", "Failed",
      "Destroyed"], Failed: ["Destroyed"], Destroyed: []});
  ...
  !function () {
    OT.PublishingState = OT.generateSimpleStateMachine("NotPublishing", "NotPublishing GetUserMedia BindingMedia MediaBound PublishingToSession Publishing Failed Destroyed".split(" "), {NotPublishing: ["NotPublishing", "GetUserMedia", "Destroyed"], GetUserMedia: ["BindingMedia", "Failed", "NotPublishing", "Destroyed"], BindingMedia: ["MediaBound", "Failed", "NotPublishing", "Destroyed"], MediaBound: ["NotPublishing", "PublishingToSession", "Failed", "Destroyed"], PublishingToSession: ["NotPublishing", "Publishing",
      "Failed", "Destroyed"], Publishing: ["NotPublishing", "MediaBound", "Failed", "Destroyed"], Failed: ["Destroyed"], Destroyed: []});
  ...
  !function () {
    var b = {audio: !0, video: !0};
    OT.Publisher = function () {
      if (OT.checkSystemRequirements()) {
        var a = OT.Publisher.nextId(), d, l, c, k, f, g, h = {}, m = !1, e, n, q, r, p, t = new OT.Analytics, v, s = [1, 7, 15, 30], u, x, E = OT.$.hasCapabilities("webAudio"), y, B = this;
        v = {"320x240": {width: 320, height: 240}, "640x480": {width: 640, height: 480}, "1280x720": {width: 1280, height: 720}};
        OT.$.now();
        OT.$.eventing(this);
        if (E) {
          ...
          var A = new OT.IntervalRunner(function () {
            ...
            60);
          this.on({"audioLevelUpdated:added": function (a) {
            1 === a && A.start()
          }, "audioLevelUpdated:removed": function (a) {
            0 === a && A.stop()
          }})
        }
        OT.StylableComponent(this, {showArchiveStatus: !0, nameDisplayMode: "auto", buttonDisplayMode: "auto", audioLevelDisplayMode: "auto", backgroundImageURI: null});
        var w = function (b, d, e, f) {
            t.logEvent({action: b, variation: d, payload_type: e, payload: f, session_id: g ? g.sessionId : null, connection_id: g && g.isConnected() ? g.connection.connectionId : null, partner_id: g ? g.apiKey : OT.APIKEY, streamId: c ? c.id :
              null, widget_id: a, widget_type: "Publisher"})
          }, F = OT.$.bind(function (b, e) {
            if (u.isPublishing()) {
              var f = {widget_type: "Publisher", stream_type: "WebRTC", sessionId: g ? g.sessionId : null, connectionId: g && g.isConnected() ? g.connection.connectionId : null, partnerId: g ? g.apiKey : OT.APIKEY, streamId: c ? c.id : null, width: d ? OT.$.width(d.domElement) : void 0, height: d ? OT.$.height(d.domElement) : void 0, widgetId: a, version: OT.properties.version, media_server_name: g ? g.sessionInfo.messagingServer : null, p2pFlag: g ? g.sessionInfo.p2pEnabled : !1,
                duration: n ? (new Date).getTime() - n.getTime() : 0, remote_connection_id: b.id};
            ...
            var b = {muted: !0, error: OT.$.bind(M, this)};
            l = d.bindVideo(f, b, OT.$.bind(function (a) {
              a ?
                (w("publish", "Failure", "reason", "Publisher PeerConnection Error: " + a), u.set("Failed"), this.trigger("publishComplete", new OT.Error(OT.ExceptionCodes.P2P_CONNECTION_FAILED, "Publisher PeerConnection Error: " + a)), OT.handleJsException("Publisher PeerConnection Error: " + a, OT.ExceptionCodes.P2P_CONNECTION_FAILED, {session: g, target: this})) : u.isDestroyed() || (OT.debug("OT.Publisher.onLoaded"), u.set("MediaBound"), d.loading(this.session ? !c : !1), m = !0, Q.call(this), this.trigger("initSuccess"), this.trigger("loaded",
                this))
            }, this));
            ...
            OT.handleJsException("Publisher failed to access camera/mic: " + a.message, OT.ExceptionCodes.UNABLE_TO_PUBLISH, {session: g, target: this})
          },
          I = function (a) {
            ...
            OT.handleJsException("Publisher PeerConnection Error: " + b, OT.ExceptionCodes.UNABLE_TO_PUBLISH, {session: g,
              target: this});
            ...
            if (!b) {
              ...
              }, disconnected: K, error: P, qos: F}, this);
              b.init(x)
            }
            return b
          }, N = function (a) {
            ...
            var a = {backingBar: new OT.Chrome.BackingBar({nameMode: !e.name ?
              "off" : this.getStyle("nameDisplayMode"), muteMode: N.call(this, this.getStyle("buttonDisplayMode"))}), name: new OT.Chrome.NamePanel({name: e.name, mode: this.getStyle("nameDisplayMode")}), muteButton: new OT.Chrome.MuteButton({muted: !1 === e.publishAudio, mode: N.call(this, this.getStyle("buttonDisplayMode"))}), archive: new OT.Chrome.Archiving({show: this.getStyle("showArchiveStatus"), archiving: !1})};
            if (E) {
              var b = new OT.AudioLevelTransformer, c = function (a) {
                p.setValue(b.transform(a.audioLevel))
              };
              p = new OT.Chrome.AudioLevelMeter({mode: this.getStyle("audioLevelDisplayMode"),
                onActivate: function () {
            ...
            r = (new OT.Chrome({parent: d.domElement})).set(a).on({muted: OT.$.bind(this.publishAudio, this, !1), unmuted: OT.$.bind(this.publishAudio, this, !0)});
        ...
        this.publish = function (a, c) {
          ...
          u.set("GetUserMedia");
          e = OT.$.defaults(c || {}, {publishAudio: !0, publishVideo: !0, mirror: !0});
          e.constraints ? OT.warn("You have passed your own constraints not using ours") : (e.constraints = OT.$.clone(b), null === e.audioSource || !1 === e.audioSource ? (e.constraints.audio = !1, e.publishAudio = !1) : ("object" === typeof e.audioSource &&
            (null != e.audioSource.deviceId ? e.audioSource = e.audioSource.deviceId : OT.warn("Invalid audioSource passed to Publisher. Expected either a device ID")), e.audioSource && ("object" !== typeof e.constraints.audio && (e.constraints.audio = {}), e.constraints.audio.mandatory || (e.constraints.audio.mandatory = {}), e.constraints.audio.optional || (e.constraints.audio.optional = []), e.constraints.audio.mandatory.sourceId = e.audioSource)), null === e.videoSource || !1 === e.videoSource ? (e.constraints.video = !1, e.publishVideo = !1) : ("object" === typeof e.videoSource && (null != e.videoSource.deviceId ? e.videoSource = e.videoSource.deviceId : OT.warn("Invalid videoSource passed to Publisher. Expected either a device ID")), e.videoSource && ("object" !== typeof e.constraints.video && (e.constraints.video = {}), e.constraints.video.mandatory || (e.constraints.video.mandatory = {}), e.constraints.video.optional || (e.constraints.video.optional = []), e.constraints.video.mandatory.sourceId = e.videoSource), e.resolution && (void 0 !== e.resolution && !v.hasOwnProperty(e.resolution) ?
            OT.warn("Invalid resolution passed to the Publisher. Got: " + e.resolution + ' expecting one of "' + OT.$.keys(v).join('","') + '"') : (e.videoDimensions = v[e.resolution], "object" !== typeof e.constraints.video && (e.constraints.video = {}), e.constraints.video.mandatory || (e.constraints.video.mandatory = {}), e.constraints.video.optional || (e.constraints.video.optional = []), e.constraints.video.optional = e.constraints.video.optional.concat([
          ...
          e.classNames = "OT_root OT_publisher";
          OT.onLoad(function () {
            ...
            OT.$.shouldAskForDevices(OT.$.bind(function (a) {
              ...
              OT.$.getUserMedia(e.constraints,
                OT.$.bind(G, this), OT.$.bind(H, this), OT.$.bind(C, this), OT.$.bind(J, this), OT.$.bind(I, this))
            }, this))
          }, this);
          return this
        };
        ...
        this.processMessage = function (a, b, c) {
          OT.debug("OT.Publisher.processMessage: Received " +
            a + " from " + b.id);
          OT.debug(c);
          switch (a) {
            case "unsubscribe":
        ...
        this._ = {publishToSession: OT.$.bind(function (a) {
          this.session = g = a;
          var b = function () {
            var b, c;
            if (g) {
              ...
              var d = OT.$.bind(function (a, b, c) {
                a ? (w("publish", "Failure", "reason", "Publish:" +
                  OT.ExceptionCodes.UNABLE_TO_PUBLISH + ":" + a.message), u.isAttemptingToPublish() && this.trigger("publishComplete", new OT.Error(OT.ExceptionCodes.UNABLE_TO_PUBLISH, a.message))) : (this.streamId = k = b, x = OT.Raptor.parseIceServers(c))
              }, this);
              ...
              a._.streamCreate(e && e.name ? e.name : "", OT.VideoOrientation.ROTATED_NORMAL, b, c, e.publishAudio,
                e.publishVideo, e.frameRate, d)
            }
          };
          if (m)b.call(this); else this.on("initSuccess", b, this);
          w("publish", "Attempt", "streamType", "WebRTC");
          return this
        }, this), unpublishFromSession: OT.$.bind(function (b, c) {
          ...
          return this
        }, this), streamDestroyed: OT.$.bind(function (a) {
        ...
        }, this), archivingStatus: OT.$.bind(function (a) {
          r && r.archive.setArchiving(a);
          return a
        }, this), webRtcStream: function () {
          return f
        }};
  ...
  !function () {
    OT.Subscriber = function (b, a) {
      var d = OT.$.uuid(), l = b || d, c, k, f, g, h, m, e, n = a.session, q, r, p = OT.$.clone(a), t = new OT.Analytics, v = 100, s, u, x = OT.$.hasCapabilities("audioOutputLevelStat") || OT.$.hasCapabilities("webAudioCapableRemoteStream"), E, y, B = !1, A = this;
      this.id = l;
      this.widgetId = d;
      this.session = n;
      OT.$.now();
      if (n) {
        OT.$.eventing(this, !1);
        if (x)this.on({"audioLevelUpdated:added": function (a) {
          1 === a && y && y.start()
        }, "audioLevelUpdated:removed": function (a) {
          0 === a && y && y.stop()
        }});
        OT.StylableComponent(this, {nameDisplayMode: "auto",
          buttonDisplayMode: "auto", audioLevelDisplayMode: "auto", videoDisabledIndicatorDisplayMode: "auto", backgroundImageURI: null, showArchiveStatus: !0, showMicButton: !0});
        var w = function (a, b, c, e) {
          t.logEvent({action: a, variation: b, payload_type: c, payload: e, stream_id: h ? h.id : null, session_id: n ? n.sessionId : null, connection_id: n && n.isConnected() ? n.connection.connectionId : null, partner_id: n && n.isConnected() ? n.sessionInfo.partnerId : null, widget_id: d, widget_type: "Subscriber"})
        }, F = OT.$.bind(function (a) {
          if (s.isSubscribing() &&
            n && n.isConnected()) {
            var b = {widget_type: "Subscriber", stream_type: "WebRTC", width: c ? OT.$.width(c.domElement) : void 0, height: c ? OT.$.height(c.domElement) : void 0, session_id: n ? n.sessionId : null, connectionId: n ? n.connection.connectionId : null, media_server_name: n ? n.sessionInfo.messagingServer : null, p2pFlag: n ? n.sessionInfo.p2pEnabled : !1, partner_id: n ? n.apiKey : null, stream_id: h.id, widget_id: d, version: OT.properties.version, duration: parseInt(OT.$.now() - q, 10), remote_connection_id: h.connection.connectionId};
            t.logQOS(OT.$.extend(b,
              a));
            this.trigger("qos", a)
          }
        }, this), G = function () {
          ...
          s.isAttemptingToSubscribe() ? (w("createPeerConnection", "Failure", "reason|hasRelayCandidates", ["Subscriber PeerConnection Error: " + a, e && e.hasRelayCandidates()].join("|")),
            s.set("Failed"), this.trigger("subscribeComplete", new OT.Error(null, a))) : s.isSubscribing() && (s.set("Failed"), this.trigger("error", a));
          this.disconnect();
          w("subscribe", "Failure", "reason", (d ? d : "") + ":Subscriber PeerConnection Error: " + a);
          OT.handleJsException("Subscriber PeerConnection Error: " + a, OT.ExceptionCodes.P2P_CONNECTION_FAILED, {session: n, target: this});
          ...
          var b = {error: H, audioVolume: v}, d = OT.$.browserVersion(), f = !1;
          ...
          k = c.bindVideo(a, b, OT.$.bind(function (a) {
            a ? H(a.message || a, e, "VideoElement") : (null != f && p.subscribeToVideo && (f.enabled = !0), k.orientation({width: h.videoDimensions.width, height: h.videoDimensions.height,
              videoOrientation: h.videoDimensions.orientation}), !s.isSubscribing() && k && (OT.debug("OT.Subscriber.onLoaded"), s.set("Subscribing"), q = OT.$.now(), w("createPeerConnection", "Success", "pcc|hasRelayCandidates", [parseInt(q - r, 10), e && e.hasRelayCandidates()].join("|")), c.loading(!1), P.call(this), B && h.setRestrictFrameRate(!0), this.trigger("subscribeComplete", null, this), this.trigger("loaded", this), w("subscribe", "Success", "streamId", h.id)))
          }, this));
          OT.$.hasCapabilities("webAudioCapableRemoteStream") && (E && 0 < a.getAudioTracks().length) &&
          (E.webOTStream = a);
          ...
          switch (a.changedProperty) {
            case "videoDimensions":
              if (!k)break;
              k.orientation({width: a.newValue.width, height: a.newValue.height, videoOrientation: a.newValue.orientation});
              break;
            case "videoDisableWarning":
              ...
              break;
            case "hasVideo":
              O(!(h.hasVideo && p.subscribeToVideo)), this.dispatchEvent(new OT.VideoEnabledChangedEvent(h.hasVideo ? "videoEnabled" : "videoDisabled", {reason: "publishVideo"}))
          }
        }, K = function (a) {
          if (!1 === a)return"off";
          a = this.getStyle("buttonDisplayMode");
          ...
          var a = {backingBar: new OT.Chrome.BackingBar({nameMode: !p.name ? "off" : this.getStyle("nameDisplayMode"),
            muteMode: K.call(this, this.getStyle("showMuteButton"))}), name: new OT.Chrome.NamePanel({name: p.name, mode: this.getStyle("nameDisplayMode")}), muteButton: new OT.Chrome.MuteButton({muted: p.muted, mode: K.call(this, this.getStyle("showMuteButton"))}), archive: new OT.Chrome.Archiving({show: this.getStyle("showArchiveStatus"), archiving: !1})};
          if (x) {
            var b = new OT.AudioLevelTransformer, d = function (a) {
              g.setValue(b.transform(a.audioLevel))
            };
            g = new OT.Chrome.AudioLevelMeter({mode: this.getStyle("audioLevelDisplayMode"),
              onActivate: function () {
          ...
          a.videoDisabledIndicator = new OT.Chrome.VideoDisabledIndicator({mode: this.getStyle("videoDisabledDisplayMode")});
          f = (new OT.Chrome({parent: c.domElement})).set(a).on({muted: function () {
            L.call(this, !0)
          }, unmuted: function () {
            L.call(this, !1)
          }}, this);
        ...
        this.subscribe = function (a) {
          OT.debug("OT.Subscriber: subscribe to " +
            a.id);
          ...
          this.stream = h = a;
          this.streamId = h.id;
          h.on({updated: M, destroyed: J}, this);
          m = a.connection.id;
          ...
          r = OT.$.now();
          if (h.connection.id !== n.connection.id)w("createPeerConnection", "Attempt", "", ""), s.set("ConnectingToPeer"), e = new OT.SubscriberPeerConnection(h.connection, n, h, this, p), e.on({disconnected: G, error: H, remoteStreamAdded: I, remoteStreamRemoved: C, qos: F}, this), e.init(), OT.$.hasCapabilities("audioOutputLevelStat") ? E = new OT.GetStatsAudioLevelSampler(e,
            "out") : OT.$.hasCapabilities("webAudioCapableRemoteStream") && (E = new OT.AnalyserAudioLevelSampler(OT.audioContext())), E && (y = new OT.IntervalRunner(function () {
            E.sample(function (a) {
        ...
        this.subscribeToAudio = function (a) {
          ...
          e && (e.subscribeToAudio(a && !p.subscribeMute),
            n && (h && a !== p.subscribeToAudio) && h.setChannelActiveState("audio", a && !p.subscribeMute));
        ...
        var L = function (a) {
          ...
          if (a !== p.mute) {
            if ("Chrome" === OT.$.browser() || TBPlugin.isInstalled())p.subscribeMute = p.muted = a, this.subscribeToAudio(p.subscribeToAudio); else if (a)p.premuteVolume = this.getAudioVolume(), p.muted = !0, this.setAudioVolume(0); else if (p.premuteVolume || p.audioVolume)p.muted = !1, this.setAudioVolume(p.premuteVolume || p.audioVolume);
            p.mute = p.mute
          }
        }, N = {auto: "quality",
          publishVideo: "publishVideo", subscribeToVideo: "subscribeToVideo"};
        this.subscribeToVideo = function (a, b) {
          ...
          u = b;
          "loading" !== b && this.dispatchEvent(new OT.VideoEnabledChangedEvent(d ?
            "videoEnabled" : "videoDisabled", {reason: N[b] || "subscribeToVideo"}));
          return this
        };
        ...
        this._ = {archivingStatus: function (a) {
      ...
      } else OT.handleJsException("Subscriber must be passed a session option", 2E3, {session: n, target: this})
    }
  }(window);
  !function () {
    var b, a, d;
    ...
    OT.SessionInfo.get = function (c, k, f) {
      var g = OT.properties.apiURL +
        "/session/" + c.id + "?extended\x3dtrue", h = OT.$.browserVersion(), l = OT.$.now();
      "IE" === h.browser && 10 > h.version ? (g = g + "\x26format\x3djson\x26token\x3d" + encodeURIComponent(c.token) + "\x26version\x3d1\x26cache\x3d" + OT.$.uuid(), h = {xdomainrequest: !0}) : h = {headers: {"X-TB-TOKEN-AUTH": c.token, "X-TB-VERSION": 1}};
      c.logEvent("getSessionInfo", "Attempt", "api_url", OT.properties.apiURL);
      OT.$.getJSON(g, h, function (e, g) {
        if (e)d(c, f, new OT.Error(e.target && e.target.status || e.code, e.message || "Could not connect to the OpenTok API Server."),
          g); else {
    ...
    b = function (a) {
      if (OT.$.isArray(a)) {
        ...
        l[b.toString()] && (b = l[b]);
        return{code: b, message: a[0].error.errorMessage &&
          a[0].error.errorMessage.message}
      }
  ...
  !function (b) {
    OT.Session = function (a, d) {
      ...
      if (OT.checkSystemRequirements()) {
        ...
        var l = !0, c = a, k, f = d, g, h = OT.$.uuid(), m, e = new OT.Analytics, n, q, r, p, t, v, s, u, x, E, y, B, A, w, F, G, H, I, C, J = OT.$.statable(this, ["disconnected", "connecting", "connected", "disconnecting"], "disconnected");
        ...
        n = function (a, b) {
          ...
          this.trigger("sessionConnectFailed",
            new OT.Error(b || OT.ExceptionCodes.CONNECT_FAILED, a));
        ...
        v = function (a) {
          ...
          "videoDisableWarning" ===
          c || "audioDisableWarning" === c || ("orientation" === c && (c = "videoDimensions", d = {width: d.width, height: d.height}), this.dispatchEvent(new OT.StreamPropertyChangedEvent(OT.Event.names.STREAM_PROPERTY_CHANGED, b, c, a.oldValue, d)))
        };
        s = function (a, b) {
          if (a.connection.id === this.connection.id)OT.$.forEach(OT.publishers.where({streamId: a.id}), OT.$.bind(function (a) {
            a._.unpublishFromSession(this, b)
          }, this)); else {
            var c = new OT.StreamEvent("streamDestroyed", a, b, !0), d = OT.$.bind(function () {
              c.isDefaultPrevented() || OT.$.forEach(OT.subscribers.where({streamId: a.id}),
                function (a) {
        ...
        B = function (a) {
          OT.$.forEach(OT.publishers.where({session: this}), function (b) {
            b.disconnect(a)
          });
          OT.$.forEach(OT.subscribers.where({session: this}), function (a) {
            a.disconnect()
          })
        };
        A = function (a) {
        ...
        w = function (a) {
          OT.$.forEach(OT.subscribers.where({session: this}), function (b) {
            b.destroy(a)
          })
        };
        F = function () {
          ...
          g.connect(k, this.sessionInfo, OT.$.bind(function (a, b) {
            if (a)g = void 0, c.splice(0, 0, a.message), this.logEvent("Connect", "Failure", "reason|webSocketServerUrl|userAgent|sdkVersion|chromeFrame", c.map(function (a) {
              return a.replace("|",
                "\\|")
            }).join("|")), n.call(this, a.message, a.code); else {
              ...
              this.connections.on({add: r, remove: p}, this);
              this.streams.on({add: t,
                remove: s, update: v}, this);
              this.archives.on({add: u, remove: x, update: E}, this);
        ...
        H = function (a) {
          if (this.is("connecting")) {
            ...
            this.sessionInfo.partnerId && this.sessionInfo.partnerId !== c ? (this.apiKey = c = this.sessionInfo.partnerId, this.logEvent("Connect", "Failure", "reason", "GetSessionInfo:" + OT.ExceptionCodes.AUTHENTICATION_ERROR + ":Authentication Error: The API key does not match the token or session."), n.call(this, "Authentication Error: The API key does not match the token or session.",
              OT.ExceptionCodes.AUTHENTICATION_ERROR)) : F.call(this)
          }
        };
        ...
        this.logEvent = function (a, b, d, g, k) {
          a = {action: a, variation: b, payload_type: d, payload: g, session_id: f, partner_id: c, widget_id: h, widget_type: "Controller"};
        ...
        this.connect = function (d) {
          if (null ==
            a && 1 < arguments.length && ("string" === typeof arguments[0] || "number" === typeof arguments[0]) && "string" === typeof arguments[1])c = d.toString(), d = arguments[1];
          ...
          l ? l = !1 : h = OT.$.uuid();
          e && OT.$.isFunction(e) && (this.once("sessionConnected", OT.$.bind(e, null, null)), this.once("sessionConnectFailed",
            e));
          ...
          this.logEvent("Connect", "Attempt", "userAgent|sdkVersion|chromeFrame",
            e.map(function (a) {
              return a.replace("|", "\\|")
            }).join("|"));
          G.call(this);
        ...
        this.publish = function (a, b, d) {
          ...
          "function" === typeof b && (d = b, b = void 0);
          if (this.isNot("connected"))return e.logError(1010,
            "OT.exception", "We need to be connected before you can publish", null, {action: "publish", variation: "Failure", payload_type: "reason", payload: "We need to be connected before you can publish", session_id: f, partner_id: c, widgetId: h, widget_type: "Controller"}), d && OT.$.isFunction(d) && C(OT.ExceptionCodes.NOT_CONNECTED, "We need to be connected before you can publish", d), null;
          if (!I("publish"))return this.logEvent("publish", "Failure", "reason", "This token does not allow publishing. The role must be at least `publisher` to enable this functionality"),
            C(OT.ExceptionCodes.UNABLE_TO_PUBLISH, "This token does not allow publishing. The role must be at least `publisher` to enable this functionality", d), null;
          if (!a || "string" === typeof a || OT.$.isElementNode(a))a = OT.initPublisher(a, b); else if (a instanceof OT.Publisher)"session"in a && (a.session && "sessionId"in a.session) && (a.session.sessionId === this.sessionId ? OT.warn("Cannot publish " + a.guid() + " again to " + this.sessionId + ". Please call session.unpublish(publisher) first.") : OT.warn("Cannot publish " + a.guid() +
            " publisher already attached to " + a.session.sessionId + ". Please call session.unpublish(publisher) first.")); else {
        ...
        this.subscribe = function (a, b, c, d) {
          if (!this.connection || !this.connection.connectionId)C(OT.ExceptionCodes.UNABLE_TO_SUBSCRIBE, "Session.subscribe :: Connection required to subscribe", d); else if (a) {
        ...
        this._ = {jsepCandidateP2p: function (a, b, c) {
        ...
        this.forceDisconnect =
          function (a, b) {
            ...
            }) : C(OT.ExceptionCodes.UNABLE_TO_FORCE_DISCONNECT, "This token does not allow forceDisconnect. The role must be at least `moderator` to enable this functionality",
              b)
          };
        this.forceUnpublish = function (a, b) {
          if (this.isNot("connected"))C(OT.ExceptionCodes.NOT_CONNECTED, "Cannot call forceUnpublish(). You are not connected to the session.", b); else if (I("forceUnpublish")) {
          ...
          } else C(OT.ExceptionCodes.UNABLE_TO_FORCE_UNPUBLISH,
            "This token does not allow forceUnpublish. The role must be at least `moderator` to enable this functionality", b)
        };
  ...
  (function () {
    function b(b) {
      ...
      this.change = OT.$.bind(function () {
        l();
        var a;
        (this.pickedDevice = k[b.selectTag.value]) ? (a = {insertMode: "append", name: this.pickedDevice.label, audioSource: null, videoSource: null, width: 220, height: 165}, a[b.mode] = this.pickedDevice.deviceId, console.log("initPublisher", b.previewTag, a), a = OT.initPublisher(b.previewTag, a), a.on({accessDialogOpened: function (a) {
          a.preventDefault()
      ...
      var f = function (b, c) {
        ...
        k[b.deviceId] = b;
        return a({value: b.deviceId}, document.createTextNode(b.label), "option")
      };
      this.setDeviceList = OT.$.bind(function (a) {
        b.selectTag.innerHTML = "";
        k = {};
        0 < a.length ? (a.map(g).map(OT.$.bind(b.selectTag.appendChild, b.selectTag)), b.selectTag.removeAttribute("disabled")) :
          f(b.selectTag, "No devices");
        this.change()
      }, this);
    ...
    OT.HardwareSetup = function (d, l, c) {
      ...
      this.destroy = OT.$.bind(function () {
        this.is("destroyed") ||
        (k && k.cleanup(), f && f.cleanup(), this.is("chooseDevices") && d.parentNode.removeChild(d), h("destroyed"))
      }, this);
      if (null == d)c(Error("You must provide a targetElement")); else if (OT.$.hasCapabilities("getMediaDevices")) {
        var m, e, n, q, r;
        m = a({style: "width: 100%"}, "", "select");
        e = a({style: "background-color: #000; margin-left: 100px; width: 220px; height: 165px;"}, "");
        n = a({style: "width: 100%"}, "", "select");
        q = a({style: "background-color: #000; margin-left: 100px; width: 220px; height: 165px;"}, "");
        r = a({id: "OT_" +
          OT.$.uuid(), style: "border: 1px solid #000; padding: 10px; width: 320px;"}, [a({style: "padding: 0 0 10px; overflow: auto; text-align: right; "}, [a({style: "float: left; width: 90px; padding-right: 10px; line-height: 160%;"}, "Camera"), a({style: "margin-left: 100px; "}, m), e]), a({style: "overflow: auto; text-align: right;"}, [a({style: "float: left; width: 90px; padding-right: 10px; line-height: 160%;"}, "Microphone"), a({style: "margin-left: 100px; "}, n), q])]);
        k = new b({selectTag: m, previewTag: e, mode: "videoSource"});
        f = new b({selectTag: n, previewTag: q, mode: "audioSource"});
        k.setLoading();
        f.setLoading();
