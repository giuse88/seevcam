...
from .views import UserProfileUpdate, UserProfileNotifications, UserProfileSettings, UserProfileIntegration, UserProfileBilling
...
html_patterns = patterns('',
                         ...
                         url(r'^billing/$', UserProfileBilling.as_view(), name='profile_billing'),
