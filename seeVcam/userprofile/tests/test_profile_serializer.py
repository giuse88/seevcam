...
class UserprofileSerializerTest(TestCase):
    userprofile_json = '{"username": "test", "email": "test@email.com", "first_name": "test_first", "last_name": "test_last", "job_title": "test_title"}'
    ...
    def test_userprofile_serializer(self):
        ...
        userprofile = SeevcamUser.objects.create_user('test', email='test@email.com', password='test_pwd',
