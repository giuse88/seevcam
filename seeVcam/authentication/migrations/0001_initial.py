...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users', (
            ...
            ('notifications', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.UserNotifications'])),
        ))
        db.send_create_signal(u'authentication', ['SeevcamUser'])

        # Adding M2M table for field groups on 'SeevcamUser'
        m2m_table_name = db.shorten_name('users_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seevcamuser', models.ForeignKey(orm[u'authentication.seevcamuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['seevcamuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'SeevcamUser'
        ...
        db.create_unique(m2m_table_name, ['seevcamuser_id', 'permission_id'])


    def backwards(self, orm):
        # Deleting model 'SeevcamUser'
        db.delete_table('users')

        # Removing M2M table for field groups on 'SeevcamUser'
        db.delete_table(db.shorten_name('users_groups'))

        # Removing M2M table for field user_permissions on 'SeevcamUser'
    ...
    models = {
        ...
        u'authentication.seevcamuser': {
            'Meta': {'object_name': 'SeevcamUser', 'db_table': "'users'"},
            ...
            'notifications': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['userprofile.UserNotifications']"}),
