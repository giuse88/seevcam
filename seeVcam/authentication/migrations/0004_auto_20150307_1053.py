...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='seevcamuser',
            name='notifications',
            field=models.OneToOneField(related_name='user_notification_settings', to='userprofile.UserNotifications'),
            preserve_default=True,
        ),
    ]
