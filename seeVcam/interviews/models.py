...
class Interview(models.Model):
    ...
    interview_job_description = models.FileField(null=False, blank=False, upload_to=settings.MEDIA_ROOT)
    ...
    candidate_cv = models.FileField(null=False, blank=False, upload_to=settings.MEDIA_ROOT)
